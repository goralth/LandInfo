...
(() => {
  ...
  var Nl = (t, e, i, r) => {
    if (e && typeof e == "object" || typeof e == "function") for (let n of Al(e)) !ql.call(t, n) && n !== i && Yi(t, n, { get: () => e[n], enumerable: !(r = Il(e, n)) || r.enumerable });
    return t;
  };
  var wt = (t, e, i) => (i = t != null ? Ol(Gl(t)) : {}, Nl(e || !t || !t.__esModule ? Yi(i, "default", { value: t, enumerable: true }) : i, t));
  var Zi = B((d_, $i) => {
    function Fl() {
  ...
  var er = B((__, tr) => {
    var Kl = ae(), Hl = Array.prototype, Xl = Hl.splice;
    function Yl(t) {
      var e = this.__data__, i = Kl(e, t);
      if (i < 0) return false;
      var r = e.length - 1;
      return i == r ? e.pop() : Xl.call(e, i, 1), --this.size, true;
    }
    tr.exports = Yl;
  });
  var rr = B((y_, ir) => {
  ...
  var ti = B((C_, _r) => {
    var uh = typeof global == "object" && global && global.Object === Object && global;
    _r.exports = uh;
  });
  var It = B((E_, yr) => {
    var ph = ti(), fh = typeof self == "object" && self && self.Object === Object && self, dh = ph || fh || Function("return this")();
    yr.exports = dh;
  });
  var Se = B((P_, Lr) => {
    var gh = It(), mh = gh.Symbol;
    Lr.exports = mh;
  });
  var vr = B((S_, Mr) => {
  ...
  var Dr = B((O_, Br) => {
    var Ah = It(), Gh = Ah["__core-js_shared__"];
    Br.exports = Gh;
  });
  var Ir = B((I_, Or) => {
  ...
  var Gr = B((A_, Ar) => {
    var Nh = Function.prototype, zh = Nh.toString;
    function Fh(t) {
      if (t != null) {
        try {
          return zh.call(t);
  ...
  var ii = B((z_, Vr) => {
    var nc = Be(), sc = It(), ac = nc(sc, "Map");
    Vr.exports = ac;
  });
  var he = B((F_, Ur) => {
    var oc = Be(), lc = oc(Object, "create");
    Ur.exports = lc;
  });
  var Xr = B((j_, Hr) => {
    var Kr = he();
  ...
  var Zr = B((U_, $r) => {
    var uc = he(), pc = "__lodash_hash_undefined__", fc = Object.prototype, dc = fc.hasOwnProperty;
    function gc(t) {
      var e = this.__data__;
      if (uc) {
        var i = e[t];
  ...
  var Qr = B((K_, Wr) => {
    var mc = he(), _c = Object.prototype, yc = _c.hasOwnProperty;
    function Lc(t) {
      var e = this.__data__;
  ...
  var on = B((Y_, an) => {
    ...
    function Tc() {
      this.size = 0, this.__data__ = { hash: new sn(), map: new (Sc || Pc)(), string: new sn() };
    }
    an.exports = Tc;
  });
  var hn = B((J_, ln) => {
  ...
  var De = B((sy, Cn) => {
    var wn = ni();
    function au(t, e, i) {
      e == "__proto__" && wn ? wn(t, e, { configurable: true, enumerable: true, value: i, writable: true }) : t[e] = i;
    }
    Cn.exports = au;
  });
  var si = B((ay, En) => {
  ...
  var An = B((ue, Xt) => {
    var fu = It(), In = typeof ue == "object" && ue && !ue.nodeType && ue, Dn = In && typeof Xt == "object" && Xt && !Xt.nodeType && Xt, du = Dn && Dn.exports === In, Rn = du ? fu.Buffer : void 0, On = Rn ? Rn.allocUnsafe : void 0;
    function gu(t, e) {
      if (e) return t.slice();
  ...
  var Yn = B((fy, Xn) => {
    var Mu = Ct(), Hn = Object.create, vu = /* @__PURE__ */ function() {
      function t() {
      }
      return function(e) {
        if (!Mu(e)) return {};
  ...
  var ai = B((gy, Zn) => {
    var wu = $n(), Cu = wu(Object.getPrototypeOf, Object);
    Zn.exports = Cu;
  });
  var oi = B((my, Wn) => {
    var Eu = Object.prototype;
    function Pu(t) {
      var e = t && t.constructor, i = typeof e == "function" && e.prototype || Eu;
      return t === i;
    }
    Wn.exports = Pu;
  });
  ...
  var li = B((by, as) => {
    var ns = rs(), qu = At(), ss = Object.prototype, Nu = ss.hasOwnProperty, zu = ss.propertyIsEnumerable, Fu = ns(/* @__PURE__ */ function() {
      return arguments;
    }()) ? ns : function(t) {
  ...
  var ci = B((pe, Jt) => {
    var Wu = It(), Qu = fs(), ms = typeof pe == "object" && pe && !pe.nodeType && pe, ds = ms && typeof Jt == "object" && Jt && !Jt.nodeType && Jt, tp = ds && ds.exports === ms, gs = tp ? Wu.Buffer : void 0, ep = gs ? gs.isBuffer : void 0, ip = ep || Qu;
    Jt.exports = ip;
  });
  var Ls = B((Cy, ys) => {
  ...
  var ks = B((Ey, bs) => {
    ...
    J[Tp] = J[Bp] = J[Dp] = J[Rp] = J[Op] = J[Ip] = J[Ap] = J[Gp] = J[qp] = true;
    J[gp] = J[mp] = J[Pp] = J[_p] = J[Sp] = J[yp] = J[Lp] = J[bp] = J[kp] = J[Mp] = J[vp] = J[xp] = J[wp] = J[Cp] = J[Ep] = false;
    function Np(t) {
  ...
  var ws = B((fe, $t) => {
    var Fp = ti(), xs = typeof fe == "object" && fe && !fe.nodeType && fe, de = xs && typeof $t == "object" && $t && !$t.nodeType && $t, jp = de && de.exports === xs, ui = jp && Fp.process, Vp = function() {
      try {
  ...
  var pi = B((Sy, Ps) => {
    var Up = ks(), Kp = vs(), Cs = ws(), Es = Cs && Cs.isTypedArray, Hp = Es ? Kp(Es) : Up;
    Ps.exports = Hp;
  });
  var fi = B((Ty, Ss) => {
    function Xp(t, e) {
  ...
  var Bs = B((By, Ts) => {
    var Yp = De(), Jp = se(), $p = Object.prototype, Zp = $p.hasOwnProperty;
    function Wp(t, e, i) {
      var r = t[e];
  ...
  var qs = B((Iy, Gs) => {
    var of = Is(), lf = li(), hf = Yt(), cf = ci(), uf = di(), pf = pi(), ff = Object.prototype, df = ff.hasOwnProperty;
    function gf(t, e) {
  ...
  var js = B((Gy, Fs) => {
    var _f = Ct(), yf = oi(), Lf = zs(), bf = Object.prototype, kf = bf.hasOwnProperty;
    function Mf(t) {
      if (!_f(t)) return Lf(t);
      var e = yf(t), i = [];
  ...
  var Zs = B((zy, $s) => {
    ...
    function Ff(t, e, i, r, n, s, a) {
      ...
      if (f) {
        var M = Ys(h), x = !M && If(h), S = !M && !x && Nf(h);
        d = h, M || x || S ? Ys(o) ? d = o : Of(o) ? d = Df(o) : x ? (f = false, d = Tf(h, true)) : S ? (f = false, d = Bf(h, true)) : d = [] : qf(h) || Xs(h) ? (d = o, Xs(o) ? d = zf(o) : (!Gf(o) || Af(o)) && (d = Rf(h))) : f = false;
      }
  ...
  var ua = B((Hy, ca) => {
    var td = la(), ha = ni(), ed = mi(), id = ha ? function(t, e) {
      return ha(t, "toString", { configurable: true, enumerable: false, value: td(e), writable: true });
    } : ed;
    ca.exports = id;
  });
  var fa = B((Xy, pa) => {
  ...
  var La = B(($y, ya) => {
    ...
    function yd(t, e, i) {
      if (!_d(i)) return false;
      var r = typeof e;
      return (r == "number" ? gd(i) && md(e, i.length) : r == "string" && e in i) ? dd(i[e], t) : false;
    }
    ya.exports = yd;
  });
  var ka = B((Zy, ba) => {
  ...
  var Oe = B((Wy, Ma) => {
    var Md = ta(), vd = ka(), xd = vd(function(t, e, i) {
      Md(t, e, i);
    });
    Ma.exports = xd;
  });
  ...
  var ro = B((ob, io) => {
    ...
    function fg(t, e) {
      if (hg(t)) return false;
      var i = typeof t;
      return i == "number" || i == "symbol" || i == "boolean" || t == null || cg(t) ? true : pg.test(t) || !ug.test(t) || e != null && t in Object(e);
    }
    io.exports = fg;
  });
  var ao = B((lb, so) => {
  ...
  var co = B((cb, ho) => {
    var yg = lo(), Lg = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, bg = /\\(\\)?/g, kg = yg(function(t) {
      var e = [];
  ...
  var Lo = B((pb, yo) => {
    var fo = Se(), vg = po(), xg = Yt(), wg = Ie(), Cg = 1 / 0, go = fo ? fo.prototype : void 0, mo = go ? go.toString : void 0;
    function _o(t) {
  ...
  var Fo = B((Ei, Pi) => {
    (function(t, e) {
      ...
      "use strict";
      function t(g, k, _, O, D) {
        (function I(G, q, c, u, p) {
          for (; u > c; ) {
            if (u - c > 600) {
              var y = u - c + 1, m = q - c + 1, v = Math.log(y), E = 0.5 * Math.exp(2 * v / 3), b = 0.5 * Math.sqrt(v * E * (y - E) / y) * (m - y / 2 < 0 ? -1 : 1), w = Math.max(c, Math.floor(q - m * E / y + b)), P = Math.min(u, Math.floor(q + (y - m) * E / y + b));
              I(G, q, w, P, p);
            }
            var C = G[q], T = c, N = u;
      ...
      function n(g, k, _) {
        if (!_) return k.indexOf(g);
        for (var O = 0; O < k.length; O++) if (_(g, k[O])) return O;
        return -1;
      }
      function s(g, k) {
        a(g, 0, g.children.length, k, g);
      }
      function a(g, k, _, O, D) {
        D || (D = S(null)), D.minX = 1 / 0, D.minY = 1 / 0, D.maxX = -1 / 0, D.maxY = -1 / 0;
        for (var I = k; I < _; I++) {
          var G = g.children[I];
          o(D, g.leaf ? O(G) : G);
        }
      ...
      function o(g, k) {
        return g.minX = Math.min(g.minX, k.minX), g.minY = Math.min(g.minY, k.minY), g.maxX = Math.max(g.maxX, k.maxX), g.maxY = Math.max(g.maxY, k.maxY), g;
      }
      function h(g, k) {
        return g.minX - k.minX;
      }
      function l(g, k) {
        return g.minY - k.minY;
      }
      function d(g) {
      ...
      function M(g, k) {
        return g.minX <= k.minX && g.minY <= k.minY && k.maxX <= g.maxX && k.maxY <= g.maxY;
      }
      function x(g, k) {
        return k.minX <= g.maxX && k.minY <= g.maxY && k.maxX >= g.minX && k.maxY >= g.minY;
      }
      function S(g) {
        return { children: g, height: 1, leaf: true, minX: 1 / 0, minY: 1 / 0, maxX: -1 / 0, maxY: -1 / 0 };
      }
      function A(g, k, _, O, D) {
        for (var I = [k, _]; I.length; ) if (!((_ = I.pop()) - (k = I.pop()) <= O)) {
          var G = k + Math.ceil((_ - k) / O / 2) * O;
          t(g, G, k, _, D), I.push(k, G, G, _);
        }
      }
      return r.prototype.all = function() {
        ...
        var k = this.data, _ = [];
        if (!x(g, k)) return _;
        for (var O = this.toBBox, D = []; k; ) {
          for (var I = 0; I < k.children.length; I++) {
            var G = k.children[I], q = k.leaf ? O(G) : G;
            x(g, q) && (k.leaf ? _.push(G) : M(g, q) ? this._all(G, _) : D.push(G));
          }
          k = D.pop();
        }
        return _;
        ...
        var k = this.data;
        if (!x(g, k)) return false;
        for (var _ = []; k; ) {
          for (var O = 0; O < k.children.length; O++) {
            var D = k.children[O], I = k.leaf ? this.toBBox(D) : D;
            if (x(g, I)) {
              if (k.leaf || M(g, I)) return true;
              _.push(D);
            }
          }
          k = _.pop();
        ...
        if (g.length < this._minEntries) {
          for (var k = 0; k < g.length; k++) this.insert(g[k]);
          return this;
        }
      ...
      }, r.prototype.remove = function(g, k) {
        if (!g) return this;
        for (var _, O, D, I = this.data, G = this.toBBox(g), q = [], c = []; I || q.length; ) {
          if (I || (I = q.pop(), O = q[q.length - 1], _ = c.pop(), D = true), I.leaf) {
            var u = n(g, I.children, k);
            if (u !== -1) return I.children.splice(u, 1), q.push(I), this._condense(q), this;
          }
          D || I.leaf || !M(I, G) ? O ? (_++, I = O.children[_], D = false) : I = null : (q.push(I), c.push(_), _ = 0, O = I, I = I.children[0]);
        }
        return this;
      }, r.prototype.toBBox = function(g) {
        return g;
      }, r.prototype.compareMinX = function(g, k) {
        return g.minX - k.minX;
      }, r.prototype.compareMinY = function(g, k) {
        return g.minY - k.minY;
      }, r.prototype.toJSON = function() {
        return this.data;
      }, r.prototype.fromJSON = function(g) {
        return this.data = g, this;
      }, r.prototype._all = function(g, k) {
        for (var _ = []; g; ) g.leaf ? k.push.apply(k, g.children) : _.push.apply(_, g.children), g = _.pop();
        return k;
      }, r.prototype._build = function(g, k, _, O) {
        var D, I = _ - k + 1, G = this._maxEntries;
        if (I <= G) return s(D = S(g.slice(k, _ + 1)), this.toBBox), D;
        O || (O = Math.ceil(Math.log(I) / Math.log(G)), G = Math.ceil(I / Math.pow(G, O - 1))), (D = S([])).leaf = false, D.height = O;
        var q = Math.ceil(I / G), c = q * Math.ceil(Math.sqrt(G));
        A(g, k, _, c, this.compareMinX);
        for (var u = k; u <= _; u += c) {
          var p = Math.min(u + c - 1, _);
          A(g, u, p, q, this.compareMinY);
          for (var y = u; y <= p; y += q) {
            var m = Math.min(y + q - 1, p);
            D.children.push(this._build(g, y, m, O - 1));
          }
        }
        return s(D, this.toBBox), D;
      }, r.prototype._chooseSubtree = function(g, k, _, O) {
        for (; O.push(k), !k.leaf && O.length - 1 !== _; ) {
          for (var D = 1 / 0, I = 1 / 0, G = void 0, q = 0; q < k.children.length; q++) {
            var c = k.children[q], u = d(c), p = (y = g, m = c, (Math.max(m.maxX, y.maxX) - Math.min(m.minX, y.minX)) * (Math.max(m.maxY, y.maxY) - Math.min(m.minY, y.minY)) - u);
            p < I ? (I = p, D = u < D ? u : D, G = c) : p === I && u < D && (D = u, G = c);
          }
          k = G || k.children[0];
        }
        var y, m;
        return k;
      }, r.prototype._insert = function(g, k, _) {
        var O = _ ? g : this.toBBox(g), D = [], I = this._chooseSubtree(O, this.data, k, D);
        for (I.children.push(g), o(I, O); k >= 0 && D[k].children.length > this._maxEntries; ) this._split(D, k), k--;
        this._adjustParentBBoxes(O, D, k);
      }, r.prototype._split = function(g, k) {
        var _ = g[k], O = _.children.length, D = this._minEntries;
        this._chooseSplitAxis(_, D, O);
        var I = this._chooseSplitIndex(_, D, O), G = S(_.children.splice(I, _.children.length - I));
        G.height = _.height, G.leaf = _.leaf, s(_, this.toBBox), s(G, this.toBBox), k ? g[k - 1].children.push(G) : this._splitRoot(_, G);
      }, r.prototype._splitRoot = function(g, k) {
        this.data = S([g, k]), this.data.height = g.height + 1, this.data.leaf = false, s(this.data, this.toBBox);
      }, r.prototype._chooseSplitIndex = function(g, k, _) {
        for (var O, D, I, G, q, c, u, p = 1 / 0, y = 1 / 0, m = k; m <= _ - k; m++) {
          var v = a(g, 0, m, this.toBBox), E = a(g, m, _, this.toBBox), b = (D = v, I = E, G = void 0, q = void 0, c = void 0, u = void 0, G = Math.max(D.minX, I.minX), q = Math.max(D.minY, I.minY), c = Math.min(D.maxX, I.maxX), u = Math.min(D.maxY, I.maxY), Math.max(0, c - G) * Math.max(0, u - q)), w = d(v) + d(E);
          b < p ? (p = b, O = m, y = w < y ? w : y) : b === p && w < y && (y = w, O = m);
        }
        return O || _ - k;
      }, r.prototype._chooseSplitAxis = function(g, k, _) {
        var O = g.leaf ? this.compareMinX : h, D = g.leaf ? this.compareMinY : l;
        this._allDistMargin(g, k, _, O) < this._allDistMargin(g, k, _, D) && g.children.sort(O);
      }, r.prototype._allDistMargin = function(g, k, _, O) {
        g.children.sort(O);
        for (var D = this.toBBox, I = a(g, 0, k, D), G = a(g, _ - k, _, D), q = f(I) + f(G), c = k; c < _ - k; c++) {
          var u = g.children[c];
          o(I, g.leaf ? D(u) : u), q += f(I);
        }
        for (var p = _ - k - 1; p >= k; p--) {
          var y = g.children[p];
          o(G, g.leaf ? D(y) : y), q += f(G);
        }
        return q;
      }, r.prototype._adjustParentBBoxes = function(g, k, _) {
        for (var O = _; O >= 0; O--) o(k[O], g);
      }, r.prototype._condense = function(g) {
        for (var k = g.length - 1, _ = void 0; k >= 0; k--) g[k].children.length === 0 ? k > 0 ? (_ = g[k - 1].children).splice(_.indexOf(g[k]), 1) : this.clear() : s(g[k], this.toBBox);
      }, r;
    });
  });
  ...
  var qa = { tooltips: { placeMarker: "Kattintson a jelölő elhelyezéséhez", placeMarkerTouch: "Érintse meg a térképet a jelölő elhelyezéséhez", firstVertex: "Kattintson az első pont elhelyezéséhez", continueLine: "Kattintson a következő pont elhelyezéséhez", finishLine: "A befejezéshez kattintson egy meglévő pontra", finishPoly: "A befejezéshez kattintson az első pontra", finishRect: "Kattintson a befejezéshez", startCircle: "Kattintson a kör középpontjának elhelyezéséhez", finishCircle: "Kattintson a kör befejezéséhez", placeCircleMarker: "Kattintson a körjelölő elhelyezéséhez" }, actions: { finish: "Befejezés", cancel: "Mégse", removeLastVertex: "Utolsó pont eltávolítása" }, buttonTitles: { drawMarkerButton: "Jelölő rajzolása", drawPolyButton: "Poligon rajzolása", drawLineButton: "Vonal rajzolása", drawCircleButton: "Kör rajzolása", drawRectButton: "Négyzet rajzolása", editButton: "Elemek szerkesztése", dragButton: "Elemek mozgatása", cutButton: "Elemek vágása", deleteButton: "Elemek törlése", drawCircleMarkerButton: "Kör jelölő rajzolása", snappingButton: "Kapcsolja a jelöltőt másik elemhez vagy ponthoz", pinningButton: "Közös pontok összekötése", rotateButton: "Fólia elforgatása" } };
  ...
  var ja = { tooltips: { placeMarker: "Натисніть, щоб нанести маркер", placeMarkerTouch: "Торкніться карти, щоб розмістити маркер", firstVertex: "Натисніть, щоб нанести першу вершину", continueLine: "Натисніть, щоб продовжити малювати", finishLine: "Натисніть будь-який існуючий маркер для завершення", finishPoly: "Виберіть перший маркер, щоб завершити", finishRect: "Натисніть, щоб завершити", startCircle: "Натисніть, щоб додати центр кола", finishCircle: "Натисніть, щоб завершити коло", placeCircleMarker: "Натисніть, щоб нанести круговий маркер" }, actions: { finish: "Завершити", cancel: "Відмінити", removeLastVertex: "Видалити попередню вершину" }, buttonTitles: { drawMarkerButton: "Малювати маркер", drawPolyButton: "Малювати полігон", drawLineButton: "Малювати криву", drawCircleButton: "Малювати коло", drawRectButton: "Малювати прямокутник", editButton: "Редагувати шари", dragButton: "Перенести шари", cutButton: "Вирізати шари", deleteButton: "Видалити шари", drawCircleMarkerButton: "Малювати круговий маркер", snappingButton: "Прив’язати перетягнутий маркер до інших шарів та вершин", pinningButton: "Зв'язати спільні вершини разом", rotateButton: "Повернути шар" } };
  var Va = { tooltips: { placeMarker: "İşaretçi yerleştirmek için tıklayın", placeMarkerTouch: "İşaretçi yerleştirmek için haritaya dokunun", firstVertex: "İlk tepe noktasını yerleştirmek için tıklayın", continueLine: "Çizime devam etmek için tıklayın", finishLine: "Bitirmek için mevcut herhangi bir işaretçiyi tıklayın", finishPoly: "Bitirmek için ilk işaretçiyi tıklayın", finishRect: "Bitirmek için tıklayın", startCircle: "Daire merkezine yerleştirmek için tıklayın", finishCircle: "Daireyi bitirmek için tıklayın", placeCircleMarker: "Daire işaretçisi yerleştirmek için tıklayın" }, actions: { finish: "Bitir", cancel: "İptal", removeLastVertex: "Son köşeyi kaldır" }, buttonTitles: { drawMarkerButton: "Çizim İşaretçisi", drawPolyButton: "Çokgenler çiz", drawLineButton: "Çoklu çizgi çiz", drawCircleButton: "Çember çiz", drawRectButton: "Dikdörtgen çiz", editButton: "Katmanları düzenle", dragButton: "Katmanları sürükle", cutButton: "Katmanları kes", deleteButton: "Katmanları kaldır", drawCircleMarkerButton: "Daire işaretçisi çiz", snappingButton: "Sürüklenen işaretçiyi diğer katmanlara ve köşelere yapıştır", pinningButton: "Paylaşılan köşeleri birbirine sabitle", rotateButton: "Katmanı döndür" } };
  var Ua = { tooltips: { placeMarker: "Kliknutím vytvoříte značku", placeMarkerTouch: "Klepnutím na mapu umístíte značku", firstVertex: "Kliknutím vytvoříte první objekt", continueLine: "Kliknutím pokračujte v kreslení", finishLine: "Kliknutí na libovolnou existující značku pro dokončení", finishPoly: "Vyberte první bod pro dokončení", finishRect: "Klikněte pro dokončení", startCircle: "Kliknutím přidejte střed kruhu", finishCircle: "Нажмите, чтобы задать радиус", placeCircleMarker: "Kliknutím nastavte poloměr" }, actions: { finish: "Dokončit", cancel: "Zrušit", removeLastVertex: "Zrušit poslední akci" }, buttonTitles: { drawMarkerButton: "Přidat značku", drawPolyButton: "Nakreslit polygon", drawLineButton: "Nakreslit křivku", drawCircleButton: "Nakreslit kruh", drawRectButton: "Nakreslit obdélník", editButton: "Upravit vrstvu", dragButton: "Přeneste vrstvu", cutButton: "Vyjmout vrstvu", deleteButton: "Smazat vrstvu", drawCircleMarkerButton: "Přidat kruhovou značku", snappingButton: "Navázat tažnou značku k dalším vrstvám a vrcholům", pinningButton: "Spojit společné body dohromady", rotateButton: "Otočte vrstvu" } };
  var Ka = { tooltips: { placeMarker: "クリックしてマーカーを配置", placeMarkerTouch: "地図をタップしてマーカーを配置", firstVertex: "クリックして最初の頂点を配置", continueLine: "クリックして描画を続ける", finishLine: "任意のマーカーをクリックして終了", finishPoly: "最初のマーカーをクリックして終了", finishRect: "クリックして終了", startCircle: "クリックして円の中心を配置", finishCircle: "クリックして円の描画を終了", placeCircleMarker: "クリックして円マーカーを配置", placeText: "クリックしてテキストを配置" }, actions: { finish: "終了", cancel: "キャンセル", removeLastVertex: "最後の頂点を削除" }, buttonTitles: { drawMarkerButton: "マーカーを描画", drawPolyButton: "ポリゴンを描画", drawLineButton: "折れ線を描画", drawCircleButton: "円を描画", drawRectButton: "矩形を描画", editButton: "レイヤーを編集", dragButton: "レイヤーをドラッグ", cutButton: "レイヤーを切り取り", deleteButton: "レイヤーを削除", drawCircleMarkerButton: "円マーカーを描画", snappingButton: "ドラッグしたマーカーを他のレイヤーや頂点にスナップする", pinningButton: "共有する頂点を同時に動かす", rotateButton: "レイヤーを回転", drawTextButton: "テキストを描画" } };
  var Ha = { tooltips: { placeMarker: "Klikkaa asettaaksesi merkin", placeMarkerTouch: "Napauta karttaa asettaaksesi merkin", firstVertex: "Klikkaa asettaakseni ensimmäisen osuuden", continueLine: "Klikkaa jatkaaksesi piirtämistä", finishLine: "Klikkaa olemassa olevaa merkkiä lopettaaksesi", finishPoly: "Klikkaa ensimmäistä merkkiä lopettaaksesi", finishRect: "Klikkaa lopettaaksesi", startCircle: "Klikkaa asettaaksesi ympyrän keskipisteen", finishCircle: "Klikkaa lopettaaksesi ympyrän", placeCircleMarker: "Klikkaa asettaaksesi ympyrämerkin", placeText: "Klikkaa asettaaksesi tekstin" }, actions: { finish: "Valmis", cancel: "Peruuta", removeLastVertex: "Poista viimeinen osuus" }, buttonTitles: { drawMarkerButton: "Piirrä merkkejä", drawPolyButton: "Piirrä monikulmioita", drawLineButton: "Piirrä viivoja", drawCircleButton: "Piirrä ympyrä", drawRectButton: "Piirrä neliskulmioita", editButton: "Muokkaa", dragButton: "Siirrä", cutButton: "Leikkaa", deleteButton: "Poista", drawCircleMarkerButton: "Piirrä ympyrämerkki", snappingButton: "Kiinnitä siirrettävä merkki toisiin muotoihin", pinningButton: "Kiinnitä jaetut muodot yhteen", rotateButton: "Käännä", drawTextButton: "Piirrä tekstiä" } };
  var Xa = { tooltips: { placeMarker: "마커 위치를 클릭하세요", placeMarkerTouch: "지도를 탭하여 마커를 배치하세요", firstVertex: "첫번째 꼭지점 위치을 클릭하세요", continueLine: "계속 그리려면 클릭하세요", finishLine: "끝내려면 기존 마커를 클릭하세요", finishPoly: "끝내려면 처음 마커를 클릭하세요", finishRect: "끝내려면 클릭하세요", startCircle: "원의 중심이 될 위치를 클릭하세요", finishCircle: "원을 끝내려면 클릭하세요", placeCircleMarker: "원 마커 위치를 클릭하세요", placeText: "텍스트 위치를 클릭하세요" }, actions: { finish: "끝내기", cancel: "취소", removeLastVertex: "마지막 꼭지점 제거" }, buttonTitles: { drawMarkerButton: "마커 그리기", drawPolyButton: "다각형 그리기", drawLineButton: "다각선 그리기", drawCircleButton: "원 그리기", drawRectButton: "직사각형 그리기", editButton: "레이어 편집하기", dragButton: "레이어 끌기", cutButton: "레이어 자르기", deleteButton: "레이어 제거하기", drawCircleMarkerButton: "원 마커 그리기", snappingButton: "잡아끈 마커를 다른 레이어 및 꼭지점에 들러붙게 하기", pinningButton: "공유 꼭지점을 함께 찍기", rotateButton: "레이어 회전하기", drawTextButton: "텍스트 그리기" } };
  var Ya = { tooltips: { placeMarker: "Маркерди жайгаштыруу үчүн басыңыз", placeMarkerTouch: "Маркерди жайгаштыруу үчүн картага тийиңиз", firstVertex: "Биринчи чокуну жайгаштырууну үчүн басыңыз", continueLine: "Сүрөт тартууну улантуу үчүн басыңыз", finishLine: "Аяктоо үчүн учурдагы маркерди басыңыз", finishPoly: "Бүтүрүү үчүн биринчи маркерди басыңыз", finishRect: "Бүтүрүү үчүн басыңыз", startCircle: "Айлананын борборун жайгаштырууну үчүн басыңыз", finishCircle: "Айлананы бүтүрүү үчүн басыңыз", placeCircleMarker: "Тегерек маркерди жайгаштыруу үчүн басыңыз", placeText: "Текстти жайгаштыруу үчүн басыңыз" }, actions: { finish: "Аягы", cancel: "Жок кылуу", removeLastVertex: "Акыркы чокуну өчүрүү" }, buttonTitles: { drawMarkerButton: "Маркерди чизуу", drawPolyButton: "Полигон чизуу", drawLineButton: "Полилиния чизуу", drawCircleButton: "Дайынды чизуу", drawRectButton: "Прямоугольник чизуу", editButton: "Слоопту түзөтүү", dragButton: "Слоопту карап сүйлөү", cutButton: "Слооптун башын кесүү", deleteButton: "Слооптун өчүрүү", drawCircleMarkerButton: "Дайынды маркерди чизуу", snappingButton: "Башка слооптордун жана вертекстердин арасына чекилдөө", pinningButton: "Бөлүшкөн вертекстерди бирге тутуштуруу", rotateButton: "Слооптун өзгөртүү", drawTextButton: "Текст чизуу", scaleButton: "Слооптун өлчөмүн өзгөртүү", autoTracingButton: "Автоматтык тизмеги чизуу" }, measurements: { totalLength: "Узундук", segmentLength: "Сегмент узундугу", area: "Аймак", radius: "Радиус", perimeter: "Периметр", height: "Диаметр", width: "Кенчилик", coordinates: "Координаттар", coordinatesMarker: "Маркердин координаттары" } };
  var Wd = _i, Et = { en: va, de: xa, it: wa, id: Ca, ro: Ea, ru: Pa, es: Sa, nl: Ta, fr: Ba, pt: Wd, pt_br: Oa, pt_pt: _i, zh: Da, zh_tw: Ra, pl: Ia, sv: Aa, el: Ga, hu: qa, da: Na, no: za, fa: Fa, ua: ja, tr: Va, cz: Ua, ja: Ka, fi: Ha, ko: Xa, ky: Ya };
  var Qd = { _globalEditModeEnabled: false, enableGlobalEditMode(t) {
    let e = { ...t };
  ...
  var tg = { _globalDragModeEnabled: false, enableGlobalDragMode() {
  ...
  var eg = { _globalRemovalModeEnabled: false, enableGlobalRemovalMode() {
  ...
  var ig = { _globalRotateModeEnabled: false, enableGlobalRotateMode() {
  ...
  var Qa = wt(Oe()), rg = { _fireDrawStart(t = "Draw", e = {}) {
  ...
  var ng = () => ({ _lastEvents: { keydown: void 0, keyup: void 0, current: void 0 }, _initKeyListener(t) {
  ...
  function So() {
    return window.matchMedia ? !window.matchMedia("(pointer: coarse)").matches : true;
  }
  function me(t) {
  ...
  function jg(t, e, i) {
    let r = { a: L.CRS.Earth.R, b: 63567523142e-4, f: 0.0033528106647474805 }, { a: n, b: s, f: a } = r, o = t.lng, h = t.lat, l = i, d = Math.PI, f = e * d / 180, M = Math.sin(f), x = Math.cos(f), S = (1 - a) * Math.tan(h * d / 180), A = 1 / Math.sqrt(1 + S * S), g = S * A, k = Math.atan2(S, x), _ = A * M, O = 1 - _ * _, D = O * (n * n - s * s) / (s * s), I = 1 + D / 16384 * (4096 + D * (-768 + D * (320 - 175 * D))), G = D / 1024 * (256 + D * (-128 + D * (74 - 47 * D))), q = l / (s * I), c = 2 * Math.PI, u, p, y;
    for (; Math.abs(q - c) > 1e-12; ) {
      u = Math.cos(2 * k + q), p = Math.sin(q), y = Math.cos(q);
      let T = G * p * (u + G / 4 * (y * (-1 + 2 * u * u) - G / 6 * u * (-3 + 4 * p * p) * (-3 + 4 * u * u)));
      c = q, q = l / (s * I) + T;
    }
    let m = g * p - A * y * x, v = Math.atan2(g * y + A * p * x, (1 - a) * Math.sqrt(_ * _ + m * m)), E = Math.atan2(p * M, A * y - g * p * x), b = a / 16 * O * (4 + a * (4 - 3 * O)), w = E - (1 - b) * a * _ * (q + b * p * (u + b * y * (-1 + 2 * u * u))), P = o + w * 180 / d, C = v * 180 / d;
    return L.latLng(P, C);
  }
  function bi(t, e, i, r, n = true) {
    let s, a, o, h = [];
    for (let l = 0; l < i; l += 1) {
  ...
  function Vg(t, e, i) {
    e = (e + 360) % 360;
    let r = Math.PI / 180, n = 180 / Math.PI, { R: s } = L.CRS.Earth, a = t.lng * r, o = t.lat * r, h = e * r, l = Math.sin(o), d = Math.cos(o), f = Math.cos(i / s), M = Math.sin(i / s), x = Math.asin(l * f + d * M * Math.cos(h)), S = a + Math.atan2(Math.sin(h) * M * d, f - l * Math.sin(x));
    S *= n;
    let A = S - 360, g = S < -180 ? S + 360 : S;
    return S = S > 180 ? A : g, L.latLng([x * n, S]);
  }
  function ye(t, e, i) {
  ...
  function To(t, e, i = "asc") {
    ...
    return (h, l) => {
      ...
      let M = d in a ? a[d] : Number.MAX_SAFE_INTEGER, x = f in a ? a[f] : Number.MAX_SAFE_INTEGER, S = 0;
      return M < x ? S = -1 : M > x && (S = 1), i === "desc" ? S * -1 : S;
    };
  }
  ...
  var Ug = L.Class.extend({ includes: [Ja, $a, Za, Wa, Pt], initialize(t) {
    this.map = t, this.Draw = new L.PM.Draw(t), this.Toolbar = new L.PM.Toolbar(t), this.Keyboard = to(), this.globalOptions = { snappable: true, layerGroup: void 0, snappingOrder: ["Marker", "CircleMarker", "Circle", "Line", "Polygon", "Rectangle"], panes: { vertexPane: "markerPane", layerPane: "overlayPane", markerPane: "markerPane" }, draggable: true, exitModeOnEscape: false, finishOnEnter: false }, this.Keyboard._initKeyListener(t);
  }, setLang(t = "en", e, i = "en") {
    t = Bo(t, Et);
  ...
  var Kg = L.Control.extend({ includes: [Pt], options: { position: "topleft", disableByOtherButtons: true }, initialize(t) {
    ...
    let n = L.DomUtil.create("div", `leaflet-pm-actions-container ${e}`, i), s = t.actions, a = { cancel: { text: F("actions.cancel"), title: F("actions.cancel"), onClick() {
      this._triggerClick();
    } }, finishMode: { text: F("actions.finish"), title: F("actions.finish"), onClick() {
      this._triggerClick();
    } }, removeLastVertex: { text: F("actions.removeLastVertex"), title: F("actions.removeLastVertex"), onClick() {
      this._map.pm.Draw[t.jsClass]._removeLastVertex();
    } }, finish: { text: F("actions.finish"), title: F("actions.finish"), onClick(h) {
    ...
    t._preparedActions = s.map((h) => {
      ...
      if (f.setAttribute("role", "button"), f.setAttribute("tabindex", "0"), f.href = "#", d.title && (f.title = d.title), f.innerHTML = d.text, L.DomEvent.disableClickPropagation(f), L.DomEvent.on(f, "click", L.DomEvent.stop), d._node = f, !t.disabled && d.onClick) {
        ...
        L.DomEvent.addListener(f, "click", M, this), L.DomEvent.addListener(f, "click", d.onClick, this), L.DomEvent.addListener(f, "click", () => this._updateActiveAction(t));
      }
      return d;
  ...
  var Hg = L.Class.extend({ options: { drawMarker: true, drawRectangle: true, drawPolyline: true, drawPolygon: true, drawCircle: true, drawCircleMarker: true, drawText: true, editMode: true, dragMode: true, cutPolygon: true, removalMode: true, rotateMode: true, snappingOption: true, drawControls: true, editControls: true, optionsControls: true, customControls: true, oneBlock: false, position: "topleft", positions: { draw: "", edit: "", options: "", custom: "" } }, customButtons: [], initialize(t) {
    ...
    let t = { className: "control-icon leaflet-pm-icon-marker", title: F("buttonTitles.drawMarkerButton"), jsClass: "Marker", onClick: () => {
    }, afterClick: (M, x) => {
      this.map.pm.Draw[x.button._button.jsClass].toggle();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, actions: ["cancel"] }, e = { title: F("buttonTitles.drawPolyButton"), className: "control-icon leaflet-pm-icon-polygon", jsClass: "Polygon", onClick: () => {
    }, afterClick: (M, x) => {
      this.map.pm.Draw[x.button._button.jsClass].toggle();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, actions: ["finish", "removeLastVertex", "cancel"] }, i = { className: "control-icon leaflet-pm-icon-polyline", title: F("buttonTitles.drawLineButton"), jsClass: "Line", onClick: () => {
    }, afterClick: (M, x) => {
      this.map.pm.Draw[x.button._button.jsClass].toggle();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, actions: ["finish", "removeLastVertex", "cancel"] }, r = { title: F("buttonTitles.drawCircleButton"), className: "control-icon leaflet-pm-icon-circle", jsClass: "Circle", onClick: () => {
    }, afterClick: (M, x) => {
      this.map.pm.Draw[x.button._button.jsClass].toggle();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, actions: ["cancel"] }, n = { title: F("buttonTitles.drawCircleMarkerButton"), className: "control-icon leaflet-pm-icon-circle-marker", jsClass: "CircleMarker", onClick: () => {
    }, afterClick: (M, x) => {
      this.map.pm.Draw[x.button._button.jsClass].toggle();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, actions: ["cancel"] }, s = { title: F("buttonTitles.drawRectButton"), className: "control-icon leaflet-pm-icon-rectangle", jsClass: "Rectangle", onClick: () => {
    }, afterClick: (M, x) => {
      this.map.pm.Draw[x.button._button.jsClass].toggle();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, actions: ["cancel"] }, a = { title: F("buttonTitles.editButton"), className: "control-icon leaflet-pm-icon-edit", onClick: () => {
    }, afterClick: () => {
      this.map.pm.toggleGlobalEditMode();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, tool: "edit", actions: ["finishMode"] }, o = { title: F("buttonTitles.dragButton"), className: "control-icon leaflet-pm-icon-drag", onClick: () => {
    }, afterClick: () => {
      this.map.pm.toggleGlobalDragMode();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, tool: "edit", actions: ["finishMode"] }, h = { title: F("buttonTitles.cutButton"), className: "control-icon leaflet-pm-icon-cut", jsClass: "Cut", onClick: () => {
    }, afterClick: (M, x) => {
      this.map.pm.Draw[x.button._button.jsClass].toggle({ snappable: true, cursorMarker: true, allowSelfIntersection: false });
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, tool: "edit", actions: ["finish", "removeLastVertex", "cancel"] }, l = { title: F("buttonTitles.deleteButton"), className: "control-icon leaflet-pm-icon-delete", onClick: () => {
    }, afterClick: () => {
      this.map.pm.toggleGlobalRemovalMode();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, tool: "edit", actions: ["finishMode"] }, d = { title: F("buttonTitles.rotateButton"), className: "control-icon leaflet-pm-icon-rotate", onClick: () => {
    }, afterClick: () => {
      this.map.pm.toggleGlobalRotateMode();
    }, doToggle: true, toggleStatus: false, disableOtherButtons: true, position: this.options.position, tool: "edit", actions: ["finishMode"] }, f = { className: "control-icon leaflet-pm-icon-text", title: F("buttonTitles.drawTextButton"), jsClass: "Text", onClick: () => {
    }, afterClick: (M, x) => {
      this.map.pm.Draw[x.button._button.jsClass].toggle();
  ...
  var Xg = { _initSnappableMarkers() {
  ...
  }, _handleSnapping(t, e = false) {
    var _a3, _b2, _c;
    let i = t.target;
    if (i._snapped = false, this.throttledList || (this.throttledList = L.Util.throttle(this._handleThrottleSnapping, 100, this)), ((_a3 = t == null ? void 0 : t.originalEvent) == null ? void 0 : _a3.altKey) || ((_c = (_b2 = this._map) == null ? void 0 : _b2.pm) == null ? void 0 : _c.Keyboard.isAltKeyPressed())) return false;
    let r;
    if (e) {
    ...
    let o = this.options.snapDistance, h = { marker: i, shape: this._shape, snapLatLng: a, segment: n.segment, layer: this._layer, workingLayer: this._layer, layerInteractedWith: n.layer, distance: n.distance };
    if (this._fireSnapDrag(h.marker, h), this._fireSnapDrag(this._layer, h), n.distance < o) {
      i._orgLatLng = i.getLatLng(), i.setLatLng(a), i._snapped = true, i._snapInfo = h;
      let l = () => {
        this._snapLatLng = a, this._fireSnap(i, h), this._fireSnap(this._layer, h);
      }, d = this._snapLatLng || {}, f = a || {};
      (d.lat !== f.lat || d.lng !== f.lng) && l();
    } else this._snapLatLng && (this._unsnap(h), i._snapped = false, i._snapInfo = void 0, this._fireUnsnap(h.marker, h), this._fireUnsnap(this._layer, h));
    return true;
  }, _createSnapList() {
    let t = [], e = [], i = this._map;
    ...
    e.forEach((a, o) => {
      var _a3;
      if (a._parentCopy && a._parentCopy === this._layer || ((_a3 = a.getLatLngs) == null ? void 0 : _a3.call(a).flat(5).length) < 2) return;
      ...
      if (h.distance = Math.floor(h.distance), this.debugIndicatorLines) {
        if (!this.debugIndicatorLines[o]) {
          ...
          l._pmTempLayer = true, this.debugIndicatorLines[o] = l;
        }
    ...
    let n, s, a, o = (h) => {
      h.forEach((l, d) => {
        ...
        if (this.options.snapSegment) {
          let f = l, M;
          r ? M = d + 1 === h.length ? 0 : d + 1 : M = d + 1 === h.length ? void 0 : d + 1;
          let x = h[M];
          if (x) {
            let S = this._getDistanceToSegment(i, t, f, x);
            (s === void 0 || S < s) && (s = S, a = [f, x]);
          }
        } else {
    ...
    if (this.options.snapVertex) {
      ...
      if (this.options.snapMiddle) {
        let f = L.PM.Utils.calcMiddleLatLng(e, i, r), M = this._getDistance(e, f, n);
        M < a && M < o && (h = f, l = M);
      }
  ...
  Y.Marker = Y.extend({ initialize(t) {
    ...
    L.Util.setOptions(this, t), this._enabled = true, this._isTouchDevice = !So(), this._map.getContainer().classList.add("geoman-draw-cursor"), this._map.on("click", this._createMarker, this), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, true), this._isTouchDevice ? (this._createTouchHint(), this._hintMarker = L.marker(this._map.getCenter(), { ...this.options.markerStyle, opacity: 0, interactive: false }), this._setPane(this._hintMarker, "markerPane"), this._hintMarker._pmTempLayer = true) : (this._hintMarker = L.marker(this._map.getCenter(), this.options.markerStyle), this._setPane(this._hintMarker, "markerPane"), this._hintMarker._pmTempLayer = true, this._hintMarker.addTo(this._map), this.options.tooltips && this._hintMarker.bindTooltip(F("tooltips.placeMarker"), { permanent: true, offset: L.point(0, 10), direction: "bottom", opacity: 0.8 }).openTooltip(), this._map.on("mousemove", this._syncHintMarker, this)), this._layer = this._hintMarker, this.options.markerEditable && this._map.eachLayer((e) => {
      this.isRelevantMarker(e) && e.pm.enable();
    }), this._fireDrawStart(), this._setGlobalDrawMode();
  }, disable() {
    this._enabled && (this._enabled = false, this._map.getContainer().classList.remove("geoman-draw-cursor"), this._map.off("click", this._createMarker, this), this._isTouchDevice ? (this._removeTouchHint(), this._hintMarker = null) : (this._hintMarker.remove(), this._map.off("mousemove", this._syncHintMarker, this)), this._map.eachLayer((t) => {
  ...
  var lt = 63710088e-1, Jg = { centimeters: lt * 100, centimetres: lt * 100, degrees: 360 / (2 * Math.PI), feet: lt * 3.28084, inches: lt * 39.37, kilometers: lt / 1e3, kilometres: lt / 1e3, meters: lt, metres: lt, miles: lt / 1609.344, millimeters: lt * 1e3, millimetres: lt * 1e3, nauticalmiles: lt / 1852, radians: 1, yards: lt * 1.0936 };
  function ct(t, e, i = {}) {
    let r = { type: "Feature" };
  ...
  function Zg(t, e, i, r, n, s, a, o) {
    let h, l, d, f, M, x = { x: null, y: null, onLine1: false, onLine2: false };
    return h = (o - s) * (i - t) - (a - n) * (r - e), h === 0 ? x.x !== null && x.y !== null ? x : false : (l = e - s, d = t - n, f = (a - n) * l - (o - s) * d, M = (i - t) * l - (r - e) * d, l = f / h, d = M / h, x.x = t + l * (i - t), x.y = e + l * (r - e), l >= 0 && l <= 1 && (x.onLine1 = true), d >= 0 && d <= 1 && (x.onLine2 = true), x.onLine1 && x.onLine2 ? [x.x, x.y] : false);
  }
  var Wt = $g;
  Y.Line = Y.extend({ initialize(t) {
    ...
    if (this._hintMarker.setLatLng(t.latlng), this.options.snappable) {
      ...
      let i = t;
      i.target = this._hintMarker, this._handleSnapping(i, true);
    }
  ...
  function qo(t, e) {
    ...
    for (let n = 0; n < r.length; n++) for (let s = 0; s < r[n].length; s++) {
      ...
      for (let h = 0; h < r[n][s].length - 1; h++) {
        ...
        l.otherEvent = d, d.otherEvent = l, No(l, d) > 0 ? (d.isLeftEndpoint = true, l.isLeftEndpoint = false) : (l.isLeftEndpoint = true, d.isLeftEndpoint = false), e.push(l), e.push(d), a = o, Ne = Ne + 1;
      }
    }
    Ge = Ge + 1;
  }
  ...
  function em(t, e) {
    ...
    let i = t.leftSweepEvent.p.x, r = t.leftSweepEvent.p.y, n = t.rightSweepEvent.p.x, s = t.rightSweepEvent.p.y, a = e.leftSweepEvent.p.x, o = e.leftSweepEvent.p.y, h = e.rightSweepEvent.p.x, l = e.rightSweepEvent.p.y, d = (l - o) * (n - i) - (h - a) * (s - r), f = (h - a) * (r - o) - (l - o) * (i - a), M = (n - i) * (r - o) - (s - r) * (i - a);
    if (d === 0) return false;
    let x = f / d, S = M / d;
    if (x >= 0 && x <= 1 && S >= 0 && S <= 1) {
      let A = i + x * (n - i), g = r + x * (s - r);
      return [A, g];
    }
    return false;
  }
  ...
  var Vo = wt(Fo(), 1);
  function Le(t, e, i) {
    if (t !== null) for (var r, n, s, a, o, h, l, d = 0, f = 0, M, x = t.type, S = x === "FeatureCollection", A = x === "Feature", g = S ? t.features.length : 1, k = 0; k < g; k++) {
      l = S ? t.features[k].geometry : A ? t.geometry : t, M = l ? l.type === "GeometryCollection" : false, o = M ? l.geometries.length : 1;
      for (var _ = 0; _ < o; _++) {
        var O = 0, D = 0;
        if (a = M ? l.geometries[_] : l, a !== null) {
          h = a.coordinates;
          var I = a.type;
          switch (d = i && (I === "Polygon" || I === "MultiPolygon") ? 1 : 0, I) {
            case null:
              break;
            case "Point":
              if (e(h, f, k, O, D) === false) return false;
              f++, O++;
              break;
            case "LineString":
            case "MultiPoint":
              for (r = 0; r < h.length; r++) {
                if (e(h[r], f, k, O, D) === false) return false;
                f++, I === "MultiPoint" && O++;
              }
              I === "LineString" && O++;
              break;
            ...
            case "MultiLineString":
              for (r = 0; r < h.length; r++) {
                for (n = 0; n < h[r].length - d; n++) {
                  if (e(h[r][n], f, k, O, D) === false) return false;
                  f++;
                }
                I === "MultiLineString" && O++, I === "Polygon" && D++;
              }
              I === "Polygon" && O++;
              break;
            case "MultiPolygon":
              for (r = 0; r < h.length; r++) {
                for (D = 0, n = 0; n < h[r].length; n++) {
                  for (s = 0; s < h[r][n].length - d; s++) {
                    if (e(h[r][n][s], f, k, O, D) === false) return false;
                    f++;
                  }
                  D++;
                }
            ...
            case "GeometryCollection":
              for (r = 0; r < a.geometries.length; r++) if (Le(a.geometries[r], e, i) === false) return false;
              break;
            default:
  ...
  function sm(t, e) {
    var i, r, n, s, a, o, h, l, d, f, M = 0, x = t.type === "FeatureCollection", S = t.type === "Feature", A = x ? t.features.length : 1;
    for (i = 0; i < A; i++) {
      for (o = x ? t.features[i].geometry : S ? t.geometry : t, l = x ? t.features[i].properties : S ? t.properties : {}, d = x ? t.features[i].bbox : S ? t.bbox : void 0, f = x ? t.features[i].id : S ? t.id : void 0, h = o ? o.type === "GeometryCollection" : false, a = h ? o.geometries.length : 1, n = 0; n < a; n++) {
        if (s = h ? o.geometries[n] : o, s === null) {
          if (e(null, M, l, d, f) === false) return false;
          continue;
        }
        switch (s.type) {
          case "Point":
          ...
          case "MultiLineString":
          case "MultiPolygon": {
            if (e(s, M, l, d, f) === false) return false;
            break;
          }
          case "GeometryCollection": {
            for (r = 0; r < s.geometries.length; r++) if (e(s.geometries[r], M, l, d, f) === false) return false;
            break;
          }
          default:
            throw new Error("Unknown Geometry Type");
  ...
  function te(t, e) {
    sm(t, function(i, r, n, s, a) {
      ...
      switch (o) {
        ...
        case "LineString":
        case "Polygon":
          return e(ct(i, n, { bbox: s, id: a }), r, 0) === false ? false : void 0;
      }
      var h;
      switch (o) {
        case "MultiPoint":
      ...
      for (var l = 0; l < i.coordinates.length; l++) {
        var d = i.coordinates[l], f = { type: h, coordinates: d };
        if (e(ct(f, n), r, l) === false) return false;
      }
    });
  }
  function ut(t, e = {}) {
  ...
  function Si(t) {
    ...
    else if (Array.isArray(t) && t.length === 6) e = [t[0], t[1], t[3], t[4]];
  ...
  function cm(t, e) {
    let i = t[0], r = t[1], n = e[0], s = e[1], a = i < n ? i : n, o = r < s ? r : s, h = i > n ? i : n, l = r > s ? r : s;
    return [a, o, h, l];
  }
  function je(t, e, i = {}) {
  ...
  var um = Object.defineProperty, pm = Object.defineProperties, fm = Object.getOwnPropertyDescriptors, Ho = Object.getOwnPropertySymbols, dm = Object.prototype.hasOwnProperty, gm = Object.prototype.propertyIsEnumerable, Xo = (t, e, i) => e in t ? um(t, e, { enumerable: true, configurable: true, writable: true, value: i }) : t[e] = i, mm = (t, e) => {
  ...
  function Jo(t, e, i = {}) {
    ...
    let r = st(e), n = bt([1 / 0, 1 / 0], { lineStringIndex: -1, segmentIndex: -1, totalDistance: -1, lineDistance: -1, segmentDistance: -1, pointDistance: 1 / 0, multiFeatureIndex: -1, index: -1, location: -1, dist: 1 / 0 }), s = 0, a = 0, o = -1;
    return te(t, function(h, l, d) {
      o !== d && (o = d, a = 0);
      let f = mt(h), M = f.length - 2;
      for (let x = 0; x < f.length - 1; x++) {
        let S = bt(f[x]), A = st(S), g = bt(f[x + 1]), k = st(g), _ = je(S, g, i), O, D;
        k[0] === r[0] && k[1] === r[1] ? [O, D] = [k, true] : A[0] === r[0] && A[1] === r[1] ? [O, D] = [A, false] : [O, D] = bm(A, k, r);
        let I = je(e, O, i);
        if (I < n.properties.pointDistance) {
          let G = je(S, O, i);
          n = bt(O, { lineStringIndex: d, segmentIndex: D && x + 1 <= M ? x + 1 : x, totalDistance: s + G, lineDistance: a + G, segmentDistance: G, pointDistance: I, multiFeatureIndex: -1, index: -1, location: -1, dist: 1 / 0 }), n.properties = _m(mm({}, n.properties), { multiFeatureIndex: n.properties.lineStringIndex, index: n.properties.segmentIndex, location: n.properties.totalDistance, dist: n.properties.pointDistance });
        }
        s += _, a += _;
      }
    }), n;
  ...
  function be(t, e) {
    let [i, r, n] = t, [s, a, o] = e;
    return [r * o - n * a, n * s - i * o, i * a - r * s];
  }
  function ym(t) {
  ...
  function Lm(t) {
    let [e, i, r] = t, n = Math.min(Math.max(r, -1), 1), s = vi(Math.asin(n));
    return [vi(Math.atan2(i, e)), s];
  }
  function bm(t, e, i) {
    let r = Di(t), n = Di(e), s = Di(i), a = be(r, n);
    if (a[0] === 0 && a[1] === 0 && a[2] === 0) return Gt(r, n) > 0 ? [[...e], true] : [[...i], false];
    let o = be(a, s);
    if (o[0] === 0 && o[1] === 0 && o[2] === 0) return [[...e], true];
    let h = be(o, a), l = Yo(h), d = [-l[0], -l[1], -l[2]], f = Gt(s, l) > Gt(s, d) ? l : d, M = Yo(a), x = Gt(be(r, f), M), S = Gt(be(f, n), M);
    return x >= 0 && S >= 0 ? [Lm(f), false] : Gt(r, s) > Gt(n, s) ? [[...t], false] : [[...e], true];
  }
  function Ii(t, e) {
    ...
    switch (t.type !== "Feature" && (t = ct(t)), r) {
      ...
      case "Polygon":
      case "MultiPolygon":
        return $o(t, Ci(t, n, { ignoreSelfIntersections: true }));
    }
  }
  function $o(t, e) {
    var i = [], r = Ti();
  ...
  function Oi(t, e) {
    ...
    var h = Zo(e, o), l = [r], d = jo(a, function(f, M, x) {
      var S = mt(M)[1], A = st(e);
      return x === h.id ? (f.push(A), i.push(Tt(f)), Ri(A, S) ? [A] : [A, S]) : (f.push(S), f);
    }, l);
  ...
  function Zo(t, e) {
    ...
    return Qt(e, function(n) {
      var s = Jo(n, t), a = s.properties.dist;
      a < r && (i = n, r = a);
    }), i;
  }
  function Ri(t, e) {
  ...
  function qt(t, e, i, r, n) {
    let s, a, o, h, l = e[0], d = r[0], f = 0, M = 0;
    d > l == d > -l ? (s = l, l = e[++f]) : (s = d, d = r[++M]);
    let x = 0;
    if (f < t && M < i) for (d > l == d > -l ? (a = l + s, o = s - (a - l), l = e[++f]) : (a = d + s, o = s - (a - d), d = r[++M]), s = a, o !== 0 && (n[x++] = o); f < t && M < i; ) d > l == d > -l ? (a = s + l, h = a - s, o = s - (a - h) + (l - h), l = e[++f]) : (a = s + d, h = a - s, o = s - (a - h) + (d - h), d = r[++M]), s = a, o !== 0 && (n[x++] = o);
    for (; f < t; ) a = s + l, h = a - s, o = s - (a - h) + (l - h), l = e[++f], s = a, o !== 0 && (n[x++] = o);
    for (; M < i; ) a = s + d, h = a - s, o = s - (a - h) + (d - h), d = r[++M], s = a, o !== 0 && (n[x++] = o);
    return (s !== 0 || x === 0) && (n[x++] = s), x;
  }
  function Me(t, e) {
    let i = e[0];
  ...
  var km = (3 + 16 * V) * V, Mm = (2 + 12 * V) * V, vm = (9 + 64 * V) * V * V, ie = R(4), Qo = R(8), tl = R(12), el = R(16), at = R(4);
  function xm(t, e, i, r, n, s, a) {
    let o, h, l, d, f, M, x, S, A, g, k, _, O, D, I, G, q, c, u = t - n, p = i - n, y = e - s, m = r - s;
    D = u * m, M = Q * u, x = M - (M - u), S = u - x, M = Q * m, A = M - (M - m), g = m - A, I = S * g - (D - x * A - S * A - x * g), G = y * p, M = Q * y, x = M - (M - y), S = y - x, M = Q * p, A = M - (M - p), g = p - A, q = S * g - (G - x * A - S * A - x * g), k = I - q, f = I - k, ie[0] = I - (k + f) + (f - q), _ = D + k, f = _ - D, O = D - (_ - f) + (k - f), k = O - G, f = O - k, ie[1] = O - (k + f) + (f - G), c = _ + k, f = c - _, ie[2] = _ - (c - f) + (k - f), ie[3] = c;
    let v = Me(4, ie), E = Mm * a;
    if (v >= E || -v >= E || (f = t - u, o = t - (u + f) + (f - n), f = i - p, l = i - (p + f) + (f - n), f = e - y, h = e - (y + f) + (f - s), f = r - m, d = r - (m + f) + (f - s), o === 0 && h === 0 && l === 0 && d === 0) || (E = vm * a + ke * Math.abs(v), v += u * d + m * o - (y * l + p * h), v >= E || -v >= E)) return v;
    D = o * m, M = Q * o, x = M - (M - o), S = o - x, M = Q * m, A = M - (M - m), g = m - A, I = S * g - (D - x * A - S * A - x * g), G = h * p, M = Q * h, x = M - (M - h), S = h - x, M = Q * p, A = M - (M - p), g = p - A, q = S * g - (G - x * A - S * A - x * g), k = I - q, f = I - k, at[0] = I - (k + f) + (f - q), _ = D + k, f = _ - D, O = D - (_ - f) + (k - f), k = O - G, f = O - k, at[1] = O - (k + f) + (f - G), c = _ + k, f = c - _, at[2] = _ - (c - f) + (k - f), at[3] = c;
    let b = qt(4, ie, 4, at, Qo);
    D = u * d, M = Q * u, x = M - (M - u), S = u - x, M = Q * d, A = M - (M - d), g = d - A, I = S * g - (D - x * A - S * A - x * g), G = y * l, M = Q * y, x = M - (M - y), S = y - x, M = Q * l, A = M - (M - l), g = l - A, q = S * g - (G - x * A - S * A - x * g), k = I - q, f = I - k, at[0] = I - (k + f) + (f - q), _ = D + k, f = _ - D, O = D - (_ - f) + (k - f), k = O - G, f = O - k, at[1] = O - (k + f) + (f - G), c = _ + k, f = c - _, at[2] = _ - (c - f) + (k - f), at[3] = c;
    let w = qt(b, Qo, 4, at, tl);
    D = o * d, M = Q * o, x = M - (M - o), S = o - x, M = Q * d, A = M - (M - d), g = d - A, I = S * g - (D - x * A - S * A - x * g), G = h * l, M = Q * h, x = M - (M - h), S = h - x, M = Q * l, A = M - (M - l), g = l - A, q = S * g - (G - x * A - S * A - x * g), k = I - q, f = I - k, at[0] = I - (k + f) + (f - q), _ = D + k, f = _ - D, O = D - (_ - f) + (k - f), k = O - G, f = O - k, at[1] = O - (k + f) + (f - G), c = _ + k, f = c - _, at[2] = _ - (c - f) + (k - f), at[3] = c;
    let P = qt(w, tl, 4, at, el);
    return el[P - 1];
  }
  ...
  var Kk = (7 + 56 * V) * V, Hk = (3 + 28 * V) * V, Xk = (26 + 288 * V) * V * V, Yk = R(4), Jk = R(4), $k = R(4), Zk = R(4), Wk = R(4), Qk = R(4), tM = R(4), eM = R(4), iM = R(4), rM = R(8), nM = R(8), sM = R(8), aM = R(4), oM = R(8), lM = R(8), hM = R(8), cM = R(12), uM = R(192), pM = R(192);
  var gM = (10 + 96 * V) * V, mM = (4 + 48 * V) * V, _M = (44 + 576 * V) * V * V, yM = R(4), LM = R(4), bM = R(4), kM = R(4), MM = R(4), vM = R(4), xM = R(4), wM = R(4), CM = R(8), EM = R(8), PM = R(8), SM = R(8), TM = R(8), BM = R(8), DM = R(8), RM = R(8), OM = R(8), IM = R(4), AM = R(4), GM = R(4), qM = R(8), NM = R(16), zM = R(16), FM = R(16), jM = R(32), VM = R(32), UM = R(48), KM = R(64), HM = R(1152), XM = R(1152);
  var ZM = (16 + 224 * V) * V, WM = (5 + 72 * V) * V, QM = (71 + 1408 * V) * V * V, tv = R(4), ev = R(4), iv = R(4), rv = R(4), nv = R(4), sv = R(4), av = R(4), ov = R(4), lv = R(4), hv = R(4), cv = R(24), uv = R(24), pv = R(24), fv = R(24), dv = R(24), gv = R(24), mv = R(24), _v = R(24), yv = R(24), Lv = R(24), bv = R(1152), kv = R(1152), Mv = R(1152), vv = R(1152), xv = R(1152), wv = R(2304), Cv = R(2304), Ev = R(3456), Pv = R(5760), Sv = R(8), Tv = R(8), Bv = R(8), Dv = R(16), Rv = R(24), Ov = R(48), Iv = R(48), Av = R(96), Gv = R(192), qv = R(384), Nv = R(384), zv = R(384), Fv = R(768);
  var jv = R(96), Vv = R(96), Uv = R(96), Kv = R(1152);
  function rl(t, e) {
    var i, r, n = 0, s, a, o, h, l, d, f, M = t[0], x = t[1], S = e.length;
    for (i = 0; i < S; i++) {
      r = 0;
      var A = e[i], g = A.length - 1;
      if (d = A[0], d[0] !== A[g][0] && d[1] !== A[g][1]) throw new Error("First and last coordinates in a ring must be the same");
      for (a = d[0] - M, o = d[1] - x, r; r < g; r++) {
        if (f = A[r + 1], h = f[0] - M, l = f[1] - x, o === 0 && l === 0) {
  ...
  function Nt(t, e, i = {}) {
    ...
    if (a && Cm(r, a) === false) return false;
    s === "Polygon" && (o = [o]);
    let h = false;
  ...
  function re(t, e, i = {}) {
    ...
    for (let s = 0; s < n.length - 1; s++) {
      let a = false;
      if (i.ignoreEndVertices && (s === 0 && (a = "start"), s === n.length - 2 && (a = "end"), s === 0 && s + 1 === n.length - 1 && (a = "both")), Em(n[s], n[s + 1], r, a, typeof i.epsilon > "u" ? null : i.epsilon)) return true;
    }
    return false;
  }
  function Em(t, e, i, r, n) {
    let s = i[0], a = i[1], o = t[0], h = t[1], l = e[0], d = e[1], f = i[0] - o, M = i[1] - h, x = l - o, S = d - h, A = f * S - M * x;
    if (n !== null) {
      if (Math.abs(A) > n) return false;
    } else if (A !== 0) return false;
    if (Math.abs(x) === Math.abs(S) && Math.abs(x) === 0) return r ? false : i[0] === t[0] && i[1] === t[1];
    if (r) {
      if (r === "start") return Math.abs(x) >= Math.abs(S) ? x > 0 ? o < s && s <= l : l <= s && s < o : S > 0 ? h < a && a <= d : d <= a && a < h;
      if (r === "end") return Math.abs(x) >= Math.abs(S) ? x > 0 ? o <= s && s < l : l < s && s <= o : S > 0 ? h <= a && a < d : d < a && a <= h;
      if (r === "both") return Math.abs(x) >= Math.abs(S) ? x > 0 ? o < s && s < l : l < s && s < o : S > 0 ? h < a && a < d : d < a && a < h;
    } else return Math.abs(x) >= Math.abs(S) ? x > 0 ? o <= s && s <= l : l <= s && s <= o : S > 0 ? h <= a && a <= d : d <= a && a <= h;
    return false;
  }
  function Pm(t, e) {
    ...
    switch (n) {
      ...
      case "Polygon":
        switch (s) {
          case "Point":
            return Nt(r, i, { ignoreBoundary: true });
          case "LineString":
            return Gm(i, r);
          case "Polygon":
            return Gi(i, r);
  ...
  function Sm(t, e) {
    return t.coordinates.some((i) => Gi({ type: "Polygon", coordinates: i }, e));
  }
  function Tm(t, e) {
    return e.coordinates.every((i) => Gi(t, { type: "Polygon", coordinates: i }));
  }
  function Bm(t, e) {
    let i, r = false;
  ...
  function Om(t, e) {
    for (let i of e.coordinates) if (!Nt(i, t, { ignoreBoundary: true })) return false;
    return true;
  }
  function Im(t, e) {
    let i = false;
  ...
  function Gm(t, e) {
    let i = ut(t), r = ut(e);
    if (!nl(i, r)) return false;
    for (let a of e.coordinates) if (!Nt(a, t)) return false;
    let n = false, s = Am(e, t);
    for (let a of s.features) {
      let o = qm(a.geometry.coordinates[0], a.geometry.coordinates[1]);
      if (!Nt(o, t)) return false;
      !n && Nt(o, t, { ignoreBoundary: true }) && (n = true);
    }
    return n;
  }
  function Gi(t, e) {
    ...
    for (let s of n) for (let a of s) if (!Nt(a, t)) return false;
    return true;
  }
  function nl(t, e) {
  ...
  var sl = Pm;
  var El = wt(ge());
  var Nm = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, Ni = Math.ceil, ft = Math.floor, ot = "[BigNumber Error] ", al = ot + "Number primitive has more than 15 significant digits: ", _t = 1e14, j = 14, zi = 9007199254740991, Fi = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], Rt = 1e7, et = 1e9;
  function ol(t) {
    var e, i, r, n = _.prototype = { constructor: _, toString: null, valueOf: null }, s = new _(1), a = 20, o = 4, h = -7, l = 21, d = -1e7, f = 1e7, M = false, x = 1, S = 0, A = { prefix: "", groupSize: 3, secondaryGroupSize: 0, groupSeparator: ",", decimalSeparator: ".", fractionGroupSize: 0, fractionGroupSeparator: " ", suffix: "" }, g = "0123456789abcdefghijklmnopqrstuvwxyz", k = true;
    function _(c, u) {
      var p, y, m, v, E, b, w, P, C = this;
      if (!(C instanceof _)) return new _(c, u);
      if (u == null) {
        if (c && c._isBigNumber === true) {
        ...
        if ($(u, 2, g.length, "Base"), u == 10 && k) return C = new _(c), G(C, a + C.e + 1, o);
        if (P = String(c), b = typeof c == "number") {
          if (c * 0 != 0) return r(C, P, b, u);
          if (C.s = 1 / c < 0 ? (P = P.slice(1), -1) : 1, _.DEBUG && P.replace(/^0\.0*|\./, "").length > 15) throw Error(al + c);
        } else C.s = P.charCodeAt(0) === 45 ? (P = P.slice(1), -1) : 1;
        for (p = g.slice(0, u), v = E = 0, w = P.length; E < w; E++) if (p.indexOf(y = P.charAt(E)) < 0) {
          if (y == ".") {
            if (E > v) {
              v = w;
              continue;
      ...
      if (P = P.slice(E, ++w)) {
        if (w -= E, b && _.DEBUG && w > 15 && (c > zi || c !== ft(c))) throw Error(al + C.s * c);
        if ((v = v - E - 1) > f) C.c = C.e = null;
        else if (v < d) C.c = [C.e = 0];
        else {
          if (C.e = v, C.c = [], E = (v + 1) % j, v < 0 && (E += j), E < w) {
            for (E && C.c.push(+P.slice(0, E)), w -= j; E < w; ) C.c.push(+P.slice(E, E += j));
    ...
    _.clone = ol, _.ROUND_UP = 0, _.ROUND_DOWN = 1, _.ROUND_CEIL = 2, _.ROUND_FLOOR = 3, _.ROUND_HALF_UP = 4, _.ROUND_HALF_DOWN = 5, _.ROUND_HALF_EVEN = 6, _.ROUND_HALF_CEIL = 7, _.ROUND_HALF_FLOOR = 8, _.EUCLID = 9, _.config = _.set = function(c) {
      var u, p;
      if (c != null) if (typeof c == "object") {
        ...
        if (c.hasOwnProperty(u = "CRYPTO")) if (p = c[u], p === !!p) if (p) if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) M = p;
        else throw M = !p, Error(ot + "crypto unavailable");
        else M = p;
        else throw Error(ot + u + " not true or false: " + p);
        if (c.hasOwnProperty(u = "MODULO_MODE") && (p = c[u], $(p, 0, 9, u), x = p), c.hasOwnProperty(u = "POW_PRECISION") && (p = c[u], $(p, 0, et, u), S = p), c.hasOwnProperty(u = "FORMAT")) if (p = c[u], typeof p == "object") A = p;
        else throw Error(ot + u + " not an object: " + p);
        if (c.hasOwnProperty(u = "ALPHABET")) if (p = c[u], typeof p == "string" && !/^.?$|[+\-.\s]|(.).*\1/.test(p)) k = p.slice(0, 10) == "0123456789", g = p;
        else throw Error(ot + u + " invalid: " + p);
      } else throw Error(ot + "Object expected: " + c);
      return { DECIMAL_PLACES: a, ROUNDING_MODE: o, EXPONENTIAL_AT: [h, l], RANGE: [d, f], CRYPTO: M, MODULO_MODE: x, POW_PRECISION: S, FORMAT: A, ALPHABET: g };
    }, _.isBigNumber = function(c) {
      if (!c || c._isBigNumber !== true) return false;
      if (!_.DEBUG) return true;
      var u, p, y = c.c, m = c.e, v = c.s;
      t: if ({}.toString.call(y) == "[object Array]") {
        if ((v === 1 || v === -1) && m >= -et && m <= et && m === ft(m)) {
          if (y[0] === 0) {
            if (m === 0 && y.length === 1) return true;
            break t;
          }
          if (u = (m + 1) % j, u < 1 && (u += j), String(y[0]).length == u) {
      ...
      return function(p) {
        var y, m, v, E, b, w = 0, P = [], C = new _(s);
        if (p == null ? p = a : $(p, 0, et), E = Ni(p / j), M) if (crypto.getRandomValues) {
          for (y = crypto.getRandomValues(new Uint32Array(E *= 2)); w < E; ) b = y[w] * 131072 + (y[w + 1] >>> 11), b >= 9e15 ? (m = crypto.getRandomValues(new Uint32Array(2)), y[w] = m[0], y[w + 1] = m[1]) : (P.push(b % 1e14), w += 2);
          w = E / 2;
        } else if (crypto.randomBytes) {
          for (y = crypto.randomBytes(E *= 7); w < E; ) b = (y[w] & 31) * 281474976710656 + y[w + 1] * 1099511627776 + y[w + 2] * 4294967296 + y[w + 3] * 16777216 + (y[w + 4] << 16) + (y[w + 5] << 8) + y[w + 6], b >= 9e15 ? crypto.randomBytes(7).copy(y, w) : (P.push(b % 1e14), w += 7);
          w = E / 7;
        } else throw M = false, Error(ot + "crypto unavailable");
        if (!M) for (; w < E; ) b = u(), b < 9e15 && (P[w++] = b % 1e14);
        for (E = P[--w], p %= j, E && p && (b = Fi[j - p], P[w] = ft(E / b) * b); P[w] === 0; P.pop(), w--) ;
        if (w < 0) P = [v = 0];
        else {
          for (v = -1; P[0] === 0; P.splice(0, 1), v -= j) ;
          for (w = 1, b = P[0]; b >= 10; b /= 10, w++) ;
          w < j && (v -= j - w);
        }
        return C.e = v, C.c = P, C;
      };
    }(), _.sum = function() {
      for (var c = 1, u = arguments, p = new _(u[0]); c < u.length; ) p = p.plus(u[c++]);
      return p;
    }, i = /* @__PURE__ */ function() {
      var c = "0123456789";
      function u(p, y, m, v) {
        for (var E, b = [0], w, P = 0, C = p.length; P < C; ) {
          for (w = b.length; w--; b[w] *= y) ;
          for (b[0] += v.indexOf(p.charAt(P++)), E = 0; E < b.length; E++) b[E] > m - 1 && (b[E + 1] == null && (b[E + 1] = 0), b[E + 1] += b[E] / m | 0, b[E] %= m);
        }
        return b.reverse();
      }
      return function(p, y, m, v, E) {
        var b, w, P, C, T, N, z, K, Z = p.indexOf("."), tt = a, U = o;
        for (Z >= 0 && (C = S, S = 0, p = p.replace(".", ""), K = new _(y), N = K.pow(p.length - Z), S = C, K.c = u(Mt(pt(N.c), N.e, "0"), 10, m, c), K.e = K.c.length), z = u(p, y, m, E ? (b = g, c) : (b = c, g)), P = C = z.length; z[--C] == 0; z.pop()) ;
        if (!z[0]) return b.charAt(0);
        if (Z < 0 ? --P : (N.c = z, N.e = P, N.s = v, N = e(N, K, tt, U, m), z = N.c, T = N.r, P = N.e), w = P + tt + 1, Z = z[w], C = m / 2, T = T || w < 0 || z[w + 1] != null, T = U < 4 ? (Z != null || T) && (U == 0 || U == (N.s < 0 ? 3 : 2)) : Z > C || Z == C && (U == 4 || T || U == 6 && z[w - 1] & 1 || U == (N.s < 0 ? 8 : 7)), w < 1 || !z[0]) p = T ? Mt(b.charAt(1), -tt, b.charAt(0)) : b.charAt(0);
        else {
          if (z.length = w, T) for (--m; ++z[--w] > m; ) z[w] = 0, w || (++P, z = [1].concat(z));
          for (C = z.length; !z[--C]; ) ;
      ...
      function c(y, m, v) {
        var E, b, w, P, C = 0, T = y.length, N = m % Rt, z = m / Rt | 0;
        for (y = y.slice(); T--; ) w = y[T] % Rt, P = y[T] / Rt | 0, E = z * w + P * N, b = N * w + E % Rt * Rt + C, C = (b / v | 0) + (E / Rt | 0) + z * P, y[T] = b % v;
        return C && (y = [C].concat(y)), y;
      }
      function u(y, m, v, E) {
        var b, w;
        if (v != E) w = v > E ? 1 : -1;
        else for (b = w = 0; b < v; b++) if (y[b] != m[b]) {
          w = y[b] > m[b] ? 1 : -1;
          break;
        }
        return w;
      ...
      return function(y, m, v, E, b) {
        var w, P, C, T, N, z, K, Z, tt, U, H, it, Pe, We, Qe, yt, ne, ht = y.s == m.s ? 1 : -1, nt = y.c, W = m.c;
        if (!nt || !nt[0] || !W || !W[0]) return new _(!y.s || !m.s || (nt ? W && nt[0] == W[0] : !W) ? NaN : nt && nt[0] == 0 || !W ? ht * 0 : ht / 0);
        for (Z = new _(ht), tt = Z.c = [], P = y.e - m.e, ht = v + P + 1, b || (b = _t, P = dt(y.e / j) - dt(m.e / j), ht = ht / j | 0), C = 0; W[C] == (nt[C] || 0); C++) ;
        if (W[C] > (nt[C] || 0) && P--, ht < 0) tt.push(1), T = true;
        else {
          ...
          do {
            if (N = 0, w = u(W, U, yt, H), w < 0) {
              if (it = U[0], yt != H && (it = it * b + (U[1] || 0)), N = ft(it / Qe), N > 1) for (N >= b && (N = b - 1), z = c(W, N, b), K = z.length, H = U.length; u(z, U, K, H) == 1; ) N--, p(z, yt < K ? ne : W, K, b), K = z.length, w = 1;
              else N == 0 && (w = N = 1), z = W.slice(), K = z.length;
              if (K < H && (z = [0].concat(z)), p(U, z, H, b), H = U.length, w == -1) for (; u(W, U, yt, H) < 1; ) N++, p(U, yt < H ? ne : W, H, b), H = U.length;
            } else w === 0 && (N++, U = [0]);
    ...
    function O(c, u, p, y) {
      ...
      if (m = c.c[0], E = c.e, u == null) w = pt(c.c), w = y == 1 || y == 2 && (E <= h || E >= l) ? Ue(w, E) : Mt(w, E, "0");
      else if (c = G(new _(c), u, p), v = c.e, w = pt(c.c), b = w.length, y == 1 || y == 2 && (u <= v || v <= h)) {
        for (; b < u; w += "0", b++) ;
        w = Ue(w, v);
      } else if (u -= E + (y === 2 && v > E), w = Mt(w, v, "0"), v + 1 > b) {
        if (--u > 0) for (w += "."; u--; w += "0") ;
      } else if (u += v - b, u > 0) for (v + 1 == b && (w += "."); u--; w += "0") ;
      return c.s < 0 && m ? "-" + w : w;
    }
    function D(c, u) {
      for (var p, y, m = 1, v = new _(c[0]); m < c.length; m++) y = new _(c[m]), (!y.s || (p = zt(v, y)) === u || p === 0 && v.s === u) && (v = y);
      return v;
    }
    function I(c, u, p) {
    ...
    r = /* @__PURE__ */ function() {
      var c = /^(-?)0([xbo])(?=\w[\w.]*$)/i, u = /^([^.]+)\.$/, p = /^\.([^.]+)$/, y = /^-?(Infinity|NaN)$/, m = /^\s*\+(?=[\w.])|^\s+|\s+$/g;
      return function(v, E, b, w) {
        var P, C = b ? E : E.replace(m, "");
        if (y.test(C)) v.s = isNaN(C) ? null : C < 0 ? -1 : 1;
        else {
          if (!b && (C = C.replace(c, function(T, N, z) {
            return P = (z = z.toLowerCase()) == "x" ? 16 : z == "b" ? 2 : 8, !w || w == P ? N : T;
          }), w && (P = w, C = C.replace(u, "$1").replace(p, "0.$1")), E != C)) return new _(C, P);
          if (_.DEBUG) throw Error(ot + "Not a" + (w ? " base " + w : "") + " number: " + E);
          v.s = null;
        }
        v.c = v.e = null;
      };
    ...
    function G(c, u, p, y) {
      var m, v, E, b, w, P, C, T = c.c, N = Fi;
      if (T) {
        t: {
          for (m = 1, b = T[0]; b >= 10; b /= 10, m++) ;
          if (v = u - m, v < 0) v += j, E = u, w = T[P = 0], C = ft(w / N[m - E - 1] % 10);
          else if (P = Ni((v + 1) / j), P >= T.length) if (y) {
            for (; T.length <= P; T.push(0)) ;
            w = C = 0, m = 1, v %= j, E = v - j + 1;
          } else break t;
          else {
            for (w = b = T[P], m = 1; b >= 10; b /= 10, m++) ;
            v %= j, E = v - j + m, C = E < 0 ? 0 : ft(w / N[m - E - 1] % 10);
          }
          if (y = y || u < 0 || T[P + 1] != null || (E < 0 ? w : w % N[m - E - 1]), y = p < 4 ? (C || y) && (p == 0 || p == (c.s < 0 ? 3 : 2)) : C > 5 || C == 5 && (p == 4 || y || p == 6 && (v > 0 ? E > 0 ? w / N[m - E] : 0 : T[P - 1]) % 10 & 1 || p == (c.s < 0 ? 8 : 7)), u < 1 || !T[0]) return T.length = 0, y ? (u -= c.e + 1, T[0] = N[(j - u % j) % j], c.e = -u || 0) : T[0] = c.e = 0, c;
          if (v == 0 ? (T.length = P, b = 1, P--) : (T.length = P + 1, b = N[j - v], T[P] = E > 0 ? ft(w / N[m - E] % N[E]) * b : 0), y) for (; ; ) if (P == 0) {
    ...
    return n.absoluteValue = n.abs = function() {
      ...
      return zt(this, new _(c, u));
    }, n.decimalPlaces = n.dp = function(c, u) {
      var p, y, m, v = this;
      if (c != null) return $(c, 0, et), u == null ? u = o : $(u, 0, 8), G(new _(v), c + v.e + 1, u);
      if (!(p = v.c)) return null;
      if (y = ((m = p.length - 1) - dt(this.e / j)) * j, m = p[m]) for (; m % 10 == 0; m /= 10, y--) ;
      return y < 0 && (y = 0), y;
    }, n.dividedBy = n.div = function(c, u) {
      return e(this, new _(c, u), a, o);
    }, n.dividedToIntegerBy = n.idiv = function(c, u) {
      return e(this, new _(c, u), 0, 1);
    }, n.exponentiatedBy = n.pow = function(c, u) {
      var p, y, m, v, E, b, w, P, C, T = this;
      if (c = new _(c), c.c && !c.isInteger()) throw Error(ot + "Exponent not an integer: " + q(c));
      if (u != null && (u = new _(u)), b = c.e > 14, !T.c || !T.c[0] || T.c[0] == 1 && !T.e && T.c.length == 1 || !c.c || !c.c[0]) return C = new _(Math.pow(+q(T), b ? c.s * (2 - Ve(c)) : +q(c))), u ? C.mod(u) : C;
      if (w = c.s < 0, u) {
        if (u.c ? !u.c[0] : !u.s) return new _(NaN);
        y = !w && T.isInteger() && u.isInteger(), y && (T = T.mod(u));
      } else {
        if (c.e > 9 && (T.e > 0 || T.e < -1 || (T.e == 0 ? T.c[0] > 1 || b && T.c[1] >= 24e7 : T.c[0] < 8e13 || b && T.c[0] <= 9999975e7))) return v = T.s < 0 && Ve(c) ? -0 : 0, T.e > -1 && (v = 1 / v), new _(w ? 1 / v : v);
        S && (v = Ni(S / j + 2));
      }
      for (b ? (p = new _(0.5), w && (c.s = 1), P = Ve(c)) : (m = Math.abs(+q(c)), P = m % 2), C = new _(s); ; ) {
        if (P) {
          if (C = C.times(T), !C.c) break;
          v ? C.c.length > v && (C.c.length = v) : y && (C = C.mod(u));
        }
        if (m) {
          if (m = ft(m / 2), m === 0) break;
          P = m % 2;
      ...
      if (c = new _(c, u), u = c.s, !b || !u) return new _(NaN);
      if (b != u) return c.s = -u, E.plus(c);
      var w = E.e / j, P = c.e / j, C = E.c, T = c.c;
      if (!w || !P) {
        if (!C || !T) return C ? (c.s = -u, c) : new _(T ? E : NaN);
        if (!C[0] || !T[0]) return T[0] ? (c.s = -u, c) : new _(C[0] ? E : o == 3 ? -0 : 0);
      }
      if (w = dt(w), P = dt(P), C = C.slice(), b = w - P) {
        for ((v = b < 0) ? (b = -b, m = C) : (P = w, m = T), m.reverse(), u = b; u--; m.push(0)) ;
        m.reverse();
      } else for (y = (v = (b = C.length) < (u = T.length)) ? b : u, b = u = 0; u < y; u++) if (C[u] != T[u]) {
        v = C[u] < T[u];
        break;
      }
      if (v && (m = C, C = T, T = m, c.s = -c.s), u = (y = T.length) - (p = C.length), u > 0) for (; u--; C[p++] = 0) ;
      for (u = _t - 1; y > b; ) {
        if (C[--y] < T[y]) {
          for (p = y; p && !C[--p]; C[p] = u) ;
          --C[p], C[y] += _t;
      ...
      var p, y, m = this;
      return c = new _(c, u), !m.c || !c.s || c.c && !c.c[0] ? new _(NaN) : !c.c || m.c && !m.c[0] ? new _(m) : (x == 9 ? (y = c.s, c.s = 1, p = e(m, c, 0, 3), c.s = y, p.s *= y) : p = e(m, c, 0, x), c = m.minus(p.times(c)), !c.c[0] && x == 1 && (c.s = m.s), c);
    }, n.multipliedBy = n.times = function(c, u) {
      var p, y, m, v, E, b, w, P, C, T, N, z, K, Z, tt, U = this, H = U.c, it = (c = new _(c, u)).c;
      if (!H || !it || !H[0] || !it[0]) return !U.s || !c.s || H && !H[0] && !it || it && !it[0] && !H ? c.c = c.e = c.s = null : (c.s *= U.s, !H || !it ? c.c = c.e = null : (c.c = [0], c.e = 0)), c;
      for (y = dt(U.e / j) + dt(c.e / j), c.s *= U.s, w = H.length, T = it.length, w < T && (K = H, H = it, it = K, m = w, w = T, T = m), m = w + T, K = []; m--; K.push(0)) ;
      for (Z = _t, tt = Rt, m = T; --m >= 0; ) {
        for (p = 0, N = it[m] % tt, z = it[m] / tt | 0, E = w, v = m + E; v > m; ) P = H[--E] % tt, C = H[E] / tt | 0, b = z * P + C * N, P = N * P + b % tt * tt + K[v] + p, p = (P / Z | 0) + (b / tt | 0) + z * C, K[v--] = P % Z;
        K[v] = p;
      }
      ...
      var p, y = this, m = y.s;
      if (c = new _(c, u), u = c.s, !m || !u) return new _(NaN);
      if (m != u) return c.s = -u, y.minus(c);
      var v = y.e / j, E = c.e / j, b = y.c, w = c.c;
      if (!v || !E) {
        if (!b || !w) return new _(m / 0);
        if (!b[0] || !w[0]) return w[0] ? c : new _(b[0] ? y : m * 0);
      }
      if (v = dt(v), E = dt(E), b = b.slice(), m = v - E) {
        for (m > 0 ? (E = v, p = w) : (m = -m, p = b), p.reverse(); m--; p.push(0)) ;
        p.reverse();
      }
      for (m = b.length, u = w.length, m - u < 0 && (p = w, w = b, b = p, u = m), m = 0; u; ) m = (b[--u] = b[u] + w[u] + m) / _t | 0, b[u] = _t === b[u] ? 0 : b[u] % _t;
      return m && (b = [m].concat(b), ++E), I(c, b, E);
    }, n.precision = n.sd = function(c, u) {
      var p, y, m, v = this;
      if (c != null && c !== !!c) return $(c, 1, et), u == null ? u = o : $(u, 0, 8), G(new _(v), c, u);
      if (!(p = v.c)) return null;
      if (m = p.length - 1, y = m * j + 1, m = p[m]) {
        for (; m % 10 == 0; m /= 10, y--) ;
      ...
      var c, u, p, y, m, v = this, E = v.c, b = v.s, w = v.e, P = a + 4, C = new _("0.5");
      if (b !== 1 || !E || !E[0]) return new _(!b || b < 0 && (!E || E[0]) ? NaN : E ? v : 1 / 0);
      if (b = Math.sqrt(+q(v)), b == 0 || b == 1 / 0 ? (u = pt(E), (u.length + w) % 2 == 0 && (u += "0"), b = Math.sqrt(+u), w = dt((w + 1) / 2) - (w < 0 || w % 2), b == 1 / 0 ? u = "5e" + w : (u = b.toExponential(), u = u.slice(0, u.indexOf("e") + 1) + w), p = new _(u)) : p = new _(b + ""), p.c[0]) {
        for (w = p.e, b = w + P, b < 3 && (b = 0); ; ) if (m = p, p = C.times(m.plus(e(v, m, P, 1))), pt(m.c).slice(0, b) === (u = pt(p.c)).slice(0, b)) if (p.e < w && --b, u = u.slice(b - 3, b + 1), u == "9999" || !y && u == "4999") {
          if (!y && (G(m, m.e + a + 2, 0), m.times(m).eq(v))) {
            p = m;
            break;
          }
          P += 4, b += 4, y = 1;
      ...
      if (y = m.toFixed(c, u), m.c) {
        var v, E = y.split("."), b = +p.groupSize, w = +p.secondaryGroupSize, P = p.groupSeparator || "", C = E[0], T = E[1], N = m.s < 0, z = N ? C.slice(1) : C, K = z.length;
        if (w && (v = b, b = w, w = v, K -= v), b > 0 && K > 0) {
          for (v = K % b || b, C = z.substr(0, v); v < K; v += b) C += P + z.substr(v, b);
          w > 0 && (C += P + z.slice(v)), N && (C = "-" + C);
        }
        y = T ? C + (p.decimalSeparator || "") + ((w = +p.fractionGroupSize) ? T.replace(new RegExp("\\d{" + w + "}\\B", "g"), "$&" + (p.fractionGroupSeparator || "")) : T) : C;
      }
      return (p.prefix || "") + y + (p.suffix || "");
    }, n.toFraction = function(c) {
      var u, p, y, m, v, E, b, w, P, C, T, N, z = this, K = z.c;
      if (c != null && (b = new _(c), !b.isInteger() && (b.c || b.s !== 1) || b.lt(s))) throw Error(ot + "Argument " + (b.isInteger() ? "out of range: " : "not an integer: ") + q(b));
      if (!K) return new _(z);
      for (u = new _(s), P = p = new _(s), y = w = new _(s), N = pt(K), v = u.e = N.length - z.e - 1, u.c[0] = Fi[(E = v % j) < 0 ? j + E : E], c = !c || b.comparedTo(u) > 0 ? v > 0 ? u : P : b, E = f, f = 1 / 0, b = new _(N), w.c[0] = 0; C = e(b, u, 0, 1), m = p.plus(C.times(y)), m.comparedTo(c) != 1; ) p = y, y = m, P = w.plus(C.times(m = P)), w = m, u = b.minus(C.times(m = u)), b = m;
      return m = e(c.minus(p), y, 0, 1), w = w.plus(m.times(P)), p = p.plus(m.times(y)), w.s = P.s = z.s, v = v * 2, T = e(P, y, v, o).minus(z).abs().comparedTo(e(w, p, v, o).minus(z).abs()) < 1 ? [P, y] : [w, p], f = E, T;
    }, n.toNumber = function() {
      return +q(this);
      ...
      return m === null ? y ? (u = "Infinity", y < 0 && (u = "-" + u)) : u = "NaN" : (c == null ? u = m <= h || m >= l ? Ue(pt(p.c), m) : Mt(pt(p.c), m, "0") : c === 10 && k ? (p = G(new _(p), a + m + 1, o), u = Mt(pt(p.c), p.e, "0")) : ($(c, 2, g.length, "Base"), u = i(Mt(pt(p.c), m, "0"), 10, c, y, true)), y < 0 && p.c[0] && (u = "-" + u)), u;
  ...
  var dl = (t) => () => t, ji = (t) => {
    let e = t ? (i, r) => r.minus(i).abs().isLessThanOrEqualTo(t) : dl(false);
    return (i, r) => e(i, r) ? 0 : i.comparedTo(r);
  };
  function Km(t) {
    let e = t ? (i, r, n, s, a) => i.exponentiatedBy(2).isLessThanOrEqualTo(s.minus(r).exponentiatedBy(2).plus(a.minus(n).exponentiatedBy(2)).times(t)) : dl(false);
    return (i, r, n) => {
  ...
  var Hm = (t) => t, Xm = (t) => {
    if (t) {
      let e = new Ft(ji(t)), i = new Ft(ji(t)), r = (s, a) => a.addAndReturn(s), n = (s) => ({ x: r(s.x, e), y: r(s.y, i) });
      return n({ x: new gt(0), y: new gt(0) }), n;
    }
    return Hm;
  }, Vi = (t) => ({ set: (e) => {
    vt = Vi(e);
  }, reset: () => Vi(t), compare: ji(t), snap: Xm(t), orient: Km(t) }), vt = Vi(), we = (t, e) => t.ll.x.isLessThanOrEqualTo(e.x) && e.x.isLessThanOrEqualTo(t.ur.x) && t.ll.y.isLessThanOrEqualTo(e.y) && e.y.isLessThanOrEqualTo(t.ur.y), Ui = (t, e) => {
  ...
  }, hl = (t, e, i) => e.y.isZero() ? null : { x: t.x.plus(e.x.div(e.y).times(i.minus(t.y))), y: i }, cl = (t, e, i) => e.x.isZero() ? null : { x: i, y: t.y.plus(e.y.div(e.x).times(i.minus(t.x))) }, $m = (t, e, i, r) => {
    ...
    let s = { x: i.x.minus(t.x), y: i.y.minus(t.y) }, a = Ke(s, e).div(n), o = Ke(s, r).div(n), h = t.x.plus(o.times(e.x)), l = i.x.plus(a.times(r.x)), d = t.y.plus(o.times(e.y)), f = i.y.plus(a.times(r.y)), M = h.plus(l).div(2), x = d.plus(f).div(2);
    return { x: M, y: x };
  }, kt = class ml {
    constructor(e, i) {
    ...
    getLeftmostComparator(e) {
      let i = /* @__PURE__ */ new Map(), r = (n) => {
        let s = n.otherSE;
        i.set(n, { sine: Ym(this.point, e.point, s.point), cosine: Jm(this.point, e.point, s.point) });
      };
      return (n, s) => {
    ...
    static factory(e) {
      ...
      for (let r = 0, n = e.length; r < n; r++) {
        ...
        for (; a = o, o = h, l.push(o), o.point !== d; ) for (; ; ) {
          let M = o.getAvailableLinkedEvents();
          if (M.length === 0) {
          ...
          if (x !== null) {
            let A = f.splice(x)[0], g = l.splice(A.index);
            g.unshift(g[0].otherSE), i.push(new Ki(g.reverse()));
            continue;
          }
          f.push({ index: l.length, point: o.point });
          let S = o.getLeftmostComparator(a);
          h = M.sort(S)[0].otherSE;
          break;
        }
        i.push(new Ki(l));
      }
    ...
    getGeom() {
      ...
      for (let l = 1, d = this.events.length - 1; l < d; l++) {
        let f = this.events[l].point, M = this.events[l + 1].point;
        vt.orient(f, e, M) !== 0 && (i.push(f), e = f);
      }
    ...
    _composePolys(t) {
      ...
      for (let i = 0, r = t.length; i < r; i++) {
        ...
        if (!n.poly) if (n.isExteriorRing()) e.push(new ul(n));
          ...
          (s == null ? void 0 : s.poly) || e.push(new ul(s)), (_a3 = s == null ? void 0 : s.poly) == null ? void 0 : _a3.addInterior(n);
        }
      }
      return e;
    }
    ...
    run(t, e, i) {
      Ce.type = t;
      let r = [new fl(e, true)];
      for (let l = 0, d = i.length; l < d; l++) r.push(new fl(i[l], false));
      ...
      if (Ce.type === "intersection") for (let l = 0, d = r.length; l < d; l++) {
        let f = r[l];
        for (let M = l + 1, x = r.length; M < x; M++) if (Ui(f.bbox, r[M].bbox) === null) return [];
      }
      let n = new Ft(kt.compare);
      for (let l = 0, d = r.length; l < d; l++) {
        let f = r[l].getSweepEvents();
        for (let M = 0, x = f.length; M < x; M++) n.add(f[M]);
      }
      ...
      for (n.size != 0 && (a = n.first(), n.delete(a)); a; ) {
        ...
        for (let d = 0, f = l.length; d < f; d++) {
          let M = l[d];
          M.consumedBy === void 0 && n.add(M);
        }
        n.size != 0 ? (a = n.first(), n.delete(a)) : a = null;
      }
      vt.reset();
      let o = Zm.factory(s.segments);
      return new Wm(o).getGeom();
    }
    ...
    static compare(e, i) {
      ...
      if (r.isLessThan(n)) {
        ...
        if (f < 0) return 1;
        if (f > 0) return -1;
        let M = i.comparePoint(e.rightSE.point);
        return M !== 0 ? M : -1;
      }
      if (r.isGreaterThan(n)) {
        ...
        if (f !== 0) return f;
        let M = e.comparePoint(i.rightSE.point);
      ...
      if (!s.eq(a)) {
        let f = l.minus(o), M = s.minus(r), x = d.minus(h), S = a.minus(n);
        if (f.isGreaterThan(M) && x.isLessThan(S)) return 1;
        if (f.isLessThan(M) && x.isGreaterThan(S)) return -1;
      }
    ...
    static fromRing(e, i, r) {
      ...
      let h = new kt(n, true), l = new kt(s, false);
      return new He(h, l, [r], [a]);
    }
    replaceRightSE(e) {
    ...
    getIntersection(e) {
      ...
      let s = this.leftSE.point, a = this.rightSE.point, o = e.leftSE.point, h = e.rightSE.point, l = we(i, o) && this.comparePoint(o) === 0, d = we(r, s) && e.comparePoint(s) === 0, f = we(i, h) && this.comparePoint(h) === 0, M = we(r, a) && e.comparePoint(a) === 0;
      if (d && l) return M && !f ? a : !M && f ? h : null;
      if (d) return f && s.x.eq(h.x) && s.y.eq(h.y) ? null : s;
      if (l) return M && a.x.eq(o.x) && a.y.eq(o.y) ? null : o;
      if (M && f) return null;
      if (M) return a;
      if (f) return h;
      let x = $m(s, this.vector(), o, e.vector());
      return x === null || !we(n, x) ? null : vt.snap(x);
    }
    split(e) {
      let i = [], r = e.events !== void 0, n = new kt(e, true), s = new kt(e, false), a = this.rightSE;
    ...
    constructor(t, e, i) {
      ...
      let r = vt.snap({ x: new gt(t[0][0]), y: new gt(t[0][1]) });
      ...
      for (let s = 1, a = t.length; s < a; s++) {
        ...
        let o = vt.snap({ x: new gt(t[s][0]), y: new gt(t[s][1]) });
    ...
    constructor(t, e) {
      ...
      this.exteriorRing = new pl(t[0], this, true), this.bbox = { ll: { x: this.exteriorRing.bbox.ll.x, y: this.exteriorRing.bbox.ll.y }, ur: { x: this.exteriorRing.bbox.ur.x, y: this.exteriorRing.bbox.ur.y } }, this.interiorRings = [];
      for (let i = 1, r = t.length; i < r; i++) {
        let n = new pl(t[i], this, false);
    ...
    constructor(t, e) {
      ...
      this.polys = [], this.bbox = { ll: { x: new gt(Number.POSITIVE_INFINITY), y: new gt(Number.POSITIVE_INFINITY) }, ur: { x: new gt(Number.NEGATIVE_INFINITY), y: new gt(Number.NEGATIVE_INFINITY) } };
      for (let i = 0, r = t.length; i < r; i++) {
  ...
  var _l = (t, ...e) => Ye.run("intersection", t, e);
  var yl = (t, ...e) => Ye.run("difference", t, e), D0 = vt.set;
  function Ze(t) {
    let e = { type: "Feature" };
  ...
  function n_(t) {
    return Ze({ type: "LineString", coordinates: t });
  }
  function s_(t) {
    return Ze({ type: "MultiLineString", coordinates: t });
  }
  function bl(t) {
    return Ze({ type: "Polygon", coordinates: t });
  }
  function kl(t) {
    return Ze({ type: "MultiPolygon", coordinates: t });
  }
  function Ml(t, e) {
  ...
  Y.Cut = Y.Polygon.extend({ initialize(t) {
    ...
    Object.keys(e).map((n) => e[n]).filter((n) => n.pm).filter((n) => !n._pmTempLayer).filter((n) => !L.PM.optIn && !n.options.pmIgnore || L.PM.optIn && n.options.pmIgnore === false).filter((n) => n instanceof L.Polyline).filter((n) => n !== t).filter((n) => n.pm.options.allowCutting).filter((n) => this.options.layersToCut && L.Util.isArray(this.options.layersToCut) && this.options.layersToCut.length > 0 ? this.options.layersToCut.indexOf(n) > -1 : true).filter((n) => !this._layerGroup.hasLayer(n)).filter((n) => {
      ...
      if (n instanceof L.Polygon) {
        ...
        i.forEach((d) => {
          if (d && d.snapInfo) {
            let { latlng: f } = d, M = this._calcClosestLayer(f, [s]);
            if (M && M.segment && M.distance < this.options.snapDistance) {
              let { segment: x } = M;
              if (x && x.length === 2) {
                let { indexPath: S, parentPath: A, newIndex: g } = L.PM.Utils._getIndexFromSegment(l, x);
      ...
      if (h.pm.enable(n.pm.options), h.pm.disable(), n._pmTempLayer = true, t._pmTempLayer = true, n.remove(), n.removeFrom(this._map.pm._getContainingLayer()), t.remove(), t.removeFrom(this._map.pm._getContainingLayer()), h.getLayers && h.getLayers().length === 0 && this._map.pm.removeLayer({ target: h }), h instanceof L.LayerGroup ? (h.eachLayer((l) => {
      ...
      this._editedLayers.push({ layer: h, originalLayer: n });
    });
  }, _cutLayer(t, e) {
    let i = L.geoJSON(), r;
  ...
  var l_ = { _onRotateStart(t) {
    ...
    let s = this;
    function a(d, f = [], M = -1) {
      if (M > -1 && f.push(M), L.Util.isArray(d[0])) d.forEach((x, S) => a(x, f.slice(), S));
      else {
        let x = f.length > 0 ? (0, Sl.default)(s._markers, f) : s._markers[0];
        d.forEach((S, A) => {
          x[A].setLatLng(S);
        });
      }
  ...
  X.Line = X.extend({ includes: [Bl], _shape: "Line", initialize(t) {
    ...
    if (a.length <= 1 && (a.splice(0, a.length), s.length > 1 && r.length > 1 && (i = _e(i)), this._layer.setLatLngs(i), this._initMarkers(), l = true), me(i) || this._layer.remove(), i = _e(i), this._layer.setLatLngs(i), this._markers = _e(this._markers), !l && (o = r.length > 1 ? (0, xt.default)(this._markers, s) : this._markers, e._middleMarkerPrev && (this._markerGroup.removeLayer(e._middleMarkerPrev), this._removeFromCache(e._middleMarkerPrev)), e._middleMarkerNext && (this._markerGroup.removeLayer(e._middleMarkerNext), this._removeFromCache(e._middleMarkerNext)), this._markerGroup.removeLayer(e), this._removeFromCache(e), o)) {
      ...
      if (this.isPolygon() ? (d = (n + 1) % o.length, f = (n + (o.length - 1)) % o.length) : (f = n - 1 < 0 ? void 0 : n - 1, d = n + 1 >= o.length ? void 0 : n + 1), d !== f) {
        let M = o[f], x = o[d];
        this.options.hideMiddleMarkers !== true && this._createMiddleMarker(M, x);
      }
      o.splice(n, 1);
    }
    ...
    let { indexPath: e, index: i, parentPath: r } = L.PM.Utils.findDeepMarkerIndex(this._markers, t), n = e.length > 1 ? (0, xt.default)(this._markers, r) : this._markers, s = (i + 1) % n.length, a = (i + (n.length - 1)) % n.length, o = n[a], h = n[s];
    return { prevMarker: o, nextMarker: h };
  ...
  Xi.prototype = { transform(t) {
    ...
    let a = [[], [], []], o = this._matrix, h = [[o[0], o[2], o[4]], [o[1], o[3], o[5]], [0, 0, 1]], l = [[t, i, n], [e, r, s], [0, 0, 1]], d;
    t && t instanceof L.PM.Matrix && (o = t._matrix, l = [[o[0], o[2], o[4]], [o[1], o[3], o[5]], [0, 0, 1]]);
    for (let f = 0; f < 3; f += 1) for (let M = 0; M < 3; M += 1) {
      d = 0;
      for (let x = 0; x < 3; x += 1) d += h[f][x] * l[x][M];
      a[f][M] = d;
    }
    return this._matrix = [a[0][0], a[1][0], a[0][1], a[1][1], a[0][2], a[1][2]], this;
  } };
  var Dl = Xi;
  var u_ = { calcMiddleLatLng(t, e, i) {
    ...
    let r = t.getLatLng(), n = t.getRadius(), s = bi(r, n, e, 0, i), a = [];
  ...
  }, createGeodesicPolygon: bi, getTranslation: F, findDeepCoordIndex(t, e, i = true) {
    let r, n = (a) => (o, h) => {
      let l = a.concat(h);
      if (i) {
        if (o.lat && o.lat === e.lat && o.lng === e.lng) return r = l, true;
      } else if (o.lat && L.latLng(o).equals(e)) return r = l, true;
    ...
    let i, r = (s) => (a, o) => {
      let h = s.concat(o);
      return a._leaflet_id === e._leaflet_id ? (i = h, true) : Array.isArray(a) && a.some(r(h));
    };
    t.some(r([]));
    let n = {};
    ...
    let n = Ot(r, t), s = Ot(r, e), a = i * Math.PI / 180, o = Math.cos(a), h = Math.sin(a), l = (s.x - n.x) * o + (s.y - n.y) * h, d = (s.y - n.y) * o - (s.x - n.x) * h, f = l * o + n.x, M = l * h + n.y, x = -d * h + n.x, S = d * o + n.y, A = Ee(r, n), g = Ee(r, { x: f, y: M }), k = Ee(r, s), _ = Ee(r, { x, y: S });
    return [A, g, k, _];
  }, pxRadiusToMeterRadius(t, e, i) {
    let r = e.project(i), n = L.point(r.x + t, r.y);
    return e.distance(e.unproject(n), i);
  } }, Rl = u_;
  L.PM = L.PM || { version: Ji.version, Map: Do, Toolbar: Oo, Draw: Y, Edit: X, Utils: Rl, Matrix: Dl, activeLang: "en", optIn: false, initialize(t) {
    this.addInitHooks(t);
  }, setOptIn(t) {
    this.optIn = !!t;
  }, addInitHooks() {
